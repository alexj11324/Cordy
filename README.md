...
[Web App](https://orvilo.aspectlylabs.com) · [Docs](https://orvilo.aspectlylabs.com/docs) · [Download](https://github.com/alexj11324/Cordy/releases/latest) · [Self-Hosting](SELF_HOSTING.md)
...
executor**. More detail in the [docs](https://orvilo.aspectlylabs.com/docs).
