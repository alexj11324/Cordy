...
use cordy_channel::{ChatType, InboundMessage};
...
pub fn new_dingtalk_resolver_set(
    ...
    ack: Option<Arc<dyn cordy_channel_engine::resolvers::TypingNotifier>>,
...
pub(crate) fn resolved_installation(
    inst: &cordy_db::models::ChannelInstallation,
    agent_id: Uuid,
...
impl IdentityResolver for IdentityResolverImpl {
    async fn resolve_sender(
        ...
        let member = cordy_db::queries::member::get_member_by_user_and_workspace(
            &self.pool,
