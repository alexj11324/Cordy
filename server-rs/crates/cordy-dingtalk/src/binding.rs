...
//! redeem page, and their DingTalk staff id is bound to their Cordy account. It
...
pub enum BindingError {
    ...
    TokenInvalid,
    /// This DingTalk user id is already bound to a different Cordy user
...
impl BindingTokenService {
    ...
    pub async fn redeem_and_bind(
        ...
        // CONFLICT DO UPDATE WHERE cordy_user_id=… gating rejected it.
        if created.is_none() {
