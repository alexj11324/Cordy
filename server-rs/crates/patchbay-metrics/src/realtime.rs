//! Realtime collector.
//!
//! Exposes the atomic counters of [`patchbay_realtime::Metrics`] as Prometheus
...
use patchbay_realtime::Metrics as RealtimeMetrics;
...
impl RealtimeCollector {
    pub fn new(metrics: &'static RealtimeMetrics) -> Self {
        ...
        let descs = vec![
            plain("patchbay_realtime_connects_total", "Total realtime WebSocket connections opened."),
            plain("patchbay_realtime_disconnects_total", "Total realtime WebSocket connections closed."),
            plain("patchbay_realtime_active_connections", "Current realtime WebSocket connections."),
            plain("patchbay_realtime_slow_evictions_total", "Total realtime clients evicted for slow consumption."),
            plain("patchbay_realtime_messages_sent_total", "Total realtime messages sent."),
            plain("patchbay_realtime_messages_dropped_total", "Total realtime messages dropped."),
            plain("patchbay_realtime_inbound_too_large_total", "Total realtime connections closed for exceeding the inbound message size limit."),
            plain("patchbay_realtime_redis_connected", "Whether the realtime Redis relay is connected."),
            plain("patchbay_realtime_redis_xadd_total", "Total Redis XADD operations by the realtime relay."),
            plain("patchbay_realtime_redis_xadd_errors_total", "Total Redis XADD errors by the realtime relay."),
            plain("patchbay_realtime_redis_xread_total", "Total Redis XREAD operations by the realtime relay."),
            plain("patchbay_realtime_redis_xread_errors_total", "Total Redis XREAD errors by the realtime relay."),
            plain("patchbay_realtime_redis_ack_total", "Total Redis stream acknowledgements by the realtime relay."),
            desc("patchbay_realtime_redis_mirror_errors_total", "Total Redis mirror write errors by the realtime relay.", &["target"]),
            plain("patchbay_realtime_redis_mirror_divergence_total", "Total Redis mirror divergence events by the realtime relay."),
            plain("patchbay_realtime_redis_stream_trimmed_entries_total", "Total Redis Stream entries removed by retention maintenance."),
            plain("patchbay_realtime_redis_stream_missing_total", "Total observed relay stream disappearance transitions, including eviction and expiry."),
            plain("patchbay_realtime_redis_retention_errors_total", "Total Redis relay retention maintenance errors."),
            plain("patchbay_realtime_redis_streams_without_ttl", "Current number of observed relay streams missing an expiry while TTL protection is enabled."),
            plain("patchbay_realtime_redis_used_memory_bytes", "Redis used_memory sampled by the realtime relay."),
            plain("patchbay_realtime_redis_maxmemory_bytes", "Redis maxmemory sampled by the realtime relay; zero means unlimited."),
            plain("patchbay_realtime_redis_evicted_keys", "Redis instance evicted_keys sampled by the realtime relay."),
            desc("patchbay_realtime_redis_stream_entries", "Current entry count of a sampled relay stream.", &["stream"]),
            desc("patchbay_realtime_redis_stream_memory_bytes", "Sampled memory usage of a relay stream.", &["stream"]),
            desc("patchbay_realtime_redis_stream_pttl_milliseconds", "Remaining relay stream TTL in milliseconds; -1 means no TTL and -2 means missing.", &["stream"]),
        ];
        Self {
