    ...
    pub fn new() -> Self {
        Self {
            ...
            tombstone_referenced: Counter::new(
                "patchbay_channel_media_reconciler_tombstone_referenced_total",
