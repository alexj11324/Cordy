    ...
    pub fn new() -> Self {
        Self {
            operations: CounterVec::new(
                Opts::new(
                    "patchbay_channel_lease_operations_total",
