...
pub struct RegistryOptions {
    ...
    pub realtime: Option<&'static patchbay_realtime::Metrics>,
    pub daemonws: Option<&'static patchbay_daemon::hub::Metrics>,
    pub version: String,
    pub commit: String,
...
impl Registry {
    pub fn new(opts: RegistryOptions) -> Self {
        ...
        let build_info = prometheus::GaugeVec::new(
            Opts::new(
                "patchbay_build_info",
                "Build information for the Patchbay server binary.",
            ),
            &["version", "commit"],
        )
