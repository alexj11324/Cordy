...
use patchbay_auth::daemon_token_cache::{DaemonTokenCache, DaemonTokenIdentity};
...
/// with the integrations port — mirrors Go when PATCHBAY_CLOUD_FLEET_URL unset.
pub const DAEMON_WORKSPACE_HEADER: &str = "x-patchbay-daemon-workspace-id";
pub const DAEMON_ID_HEADER: &str = "x-patchbay-daemon-id";
...
pub async fn daemon_auth_middleware(
    ...
    // Cloud Node PAT: "mcn_" prefix. Patchbay Cloud Fleet is authoritative; we
