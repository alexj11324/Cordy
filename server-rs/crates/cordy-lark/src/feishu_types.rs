...
//! `cordy_channel::InboundMessage` for the channel-agnostic engine Router,
...
pub struct DispatchResult {
    pub outcome: Option<cordy_channel_engine::resolvers::Outcome>,
...
pub mod outcome {
    pub use cordy_channel_engine::resolvers::Outcome;
