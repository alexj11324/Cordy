---
name: patchbay-creating-agents
description: "Use when creating, inspecting, or debugging a Patchbay agent definition via the `patchbay agent` CLI or POST /api/agents. Not for assigning issues to agents that already exist, and not for runtime task prompts."
user-invocable: false
allowed-tools: Bash(patchbay *)
---

# Creating Patchbay agents

This is the contract for Patchbay's agent-creation path: what the create entry
