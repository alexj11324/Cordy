...
use patchbay_db::models::{Issue, PluginInstallation, User, Workspace};
...
pub async fn authorize_plugin_action(
    ...
    let installation = patchbay_db::queries::plugin::get_plugin_installation(pool, parsed).await;
...
pub fn build_plugin_context(
    ...
    let mut payload = PluginContext {
        ...
        config,
        granted_urls: patchbay_plugincontract::net_domains(&caller.scopes),
