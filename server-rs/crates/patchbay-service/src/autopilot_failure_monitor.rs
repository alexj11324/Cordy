...
use patchbay_db::models::{Autopilot, InboxItem};
use patchbay_db::queries::autopilot::SelectAutopilotsExceedingFailureThresholdRow as Candidate;
use patchbay_db::queries::{agent, autopilot, inbox, member};
...
impl AutopilotFailureMonitor {
    ...
    pub async fn process_next(
        ...
        self.bus.publish(&Event {
            event_type: patchbay_protocol::EVENT_AUTOPILOT_UPDATED.into(),
