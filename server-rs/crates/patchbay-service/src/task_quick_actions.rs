...
use patchbay_db::models::{AgentTaskQueue, ChatMessage};
...
use patchbay_protocol::messages::ChatQuickActionsPayload;
...
pub(crate) async fn chat_quick_actions_eligible(
    ...
    if msg.message_kind != patchbay_protocol::CHAT_MESSAGE_KIND_MESSAGE {
        return false;
    }
...
pub(crate) async fn supplement_chat_quick_actions(
    ...
    svc.bus.publish(&patchbay_events::Event {
        event_type: patchbay_protocol::EVENT_CHAT_QUICK_ACTIONS.to_string(),
        workspace_id,
