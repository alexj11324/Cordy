...
use patchbay_daemon::assembly::{
    DaemonLaunchOverrides, DaemonProductionAssembly, DaemonProductionInputs, DaemonProfileInput,
};
use patchbay_daemon::bootstrap::{BootstrapContext, BootstrapOptions};
use patchbay_daemon::health::RepoCheckoutRegistry;
use patchbay_daemon::lifecycle::DaemonLifecycleOptions;
use patchbay_daemon::provider_adapter::ProductionProviderAdapter;
use patchbay_daemon::provider_registration::{
...
mod tests {
    ...
    fn one_profile_snapshot_drives_lifecycle_and_successor_inputs() {
        ...
        let executable = PathBuf::from("/opt/patchbay/bin/patchbay");
    ...
    fn daemon_port_alone_does_not_block_host_start() {
        ...
        environment.set("PATCHBAY_DAEMON_PORT", "19876");
    ...
    fn foreground_assembly_rejects_missing_auth_before_touching_workspace_root() {
        ...
        let context = BootstrapContext {
            paths: patchbay_daemon::bootstrap::ProfileStatePaths {
        ...
        assert!(
            message.contains("patchbay login"),
