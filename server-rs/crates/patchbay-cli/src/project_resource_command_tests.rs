...
fn project_resource_add_parser_and_ref_shortcuts_match_go_contract() {
    let cli = Cli::try_parse_from([
        ...
        "--url",
        "https://github.com/acme/patchbay",
        "--ref",
        "2024",
        "--default-branch-hint",
        "main",
    ...
    assert_eq!(
        ...
        serde_json::json!({
            "url":"https://github.com/acme/patchbay",
            "ref":"2024",
...
async fn project_resource_list_and_add_use_go_http_and_output_contracts() {
    ...
    let app = Router::new().route(
            ...
            get(move || async move {
                Json(serde_json::json!({"resources":[{
                    ...
                    "resource_ref":{"url":"https://github.com/acme/patchbay","ref":"main"},
                    "label":"Patchbay"
                }]}))
            })
            .post(|Json(body): Json<Value>| async move {
                assert_eq!(body["resource_type"], "local_directory");
                assert_eq!(body["resource_ref"]["local_path"], "/srv/patchbay");
                assert_eq!(body["resource_ref"]["daemon_id"], "daemon-1");
                assert_eq!(body["resource_ref"]["execution_mode"], "worktree");
                Json(serde_json::json!({
                    "id":"33333333-3333-3333-3333-333333333333",
                    "resource_type":"local_directory",
                    "resource_ref":{"local_path":"/srv/patchbay","daemon_id":"daemon-1","execution_mode":"worktree"}
                }))
            }),
        );
    ...
    let list = Cli::try_parse_from([
        "patchbay", "project", "resource", "list", project_id, "--output", "table",
    ])
    ...
    assert!(listed
        .stdout
        .contains("https://github.com/acme/patchbay @ main"));
    assert!(listed.stdout.contains("Patchbay"));
    ...
    assert!(added.stdout.contains("/srv/patchbay"));
    task.abort();
}
            ...
            .route(
                ...
                put(|Json(body): Json<Value>| async move {
                    ...
                    Json(serde_json::json!({
                        ...
                        "resource_ref":{"url":"https://github.com/acme/patchbay","ref":"main","default_branch_hint":"trunk"},
                        "label":""
                    }))
                })
