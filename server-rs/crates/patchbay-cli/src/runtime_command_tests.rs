...
async fn runtime_read_commands_match_go_requests_and_tables() {
    ...
    let list = Cli::try_parse_from(["patchbay", "runtime", "list"]).expect("runtime list CLI");
    ...
    let usage = Cli::try_parse_from(["patchbay", "runtime", "usage", "runtime-1", "--days", "30"])
...
async fn runtime_rename_and_cascade_delete_match_go_contract() {
    ...
    let delete = Cli::try_parse_from(["patchbay", "runtime", "delete", "runtime-1"])
    ...
    let cascade = Cli::try_parse_from(["patchbay", "runtime", "delete", "runtime-1", "--cascade"])
...
async fn runtime_profile_registry_commands_match_go_contract() {
    ...
    let list = Cli::try_parse_from(["patchbay", "runtime", "profile", "list"])
    ...
    let delete = Cli::try_parse_from(["patchbay", "runtime", "profile", "delete", "profile-1"])
