...
use patchbay_channel_engine::session::{ChatSession, SessionTitles};
use patchbay_db::models::{ChannelInstallation, ChannelUserBinding};
...
pub fn new_slack_resolver_set(
    ...
    let session = ChatSession::new(
        pool.clone(),
        patchbay_channel::Type(TYPE_SLACK.to_string()),
        SessionTitles {
...
#[async_trait]
impl patchbay_channel_engine::resolvers::InstallationResolver for InstallationResolver {
...
#[async_trait]
impl patchbay_channel_engine::resolvers::IdentityResolver for IdentityResolver {
    async fn resolve_sender(
        ...
        if reused {
            ...
            use patchbay_db::queries::channel::create_channel_user_binding;
...
#[async_trait]
impl patchbay_channel_engine::resolvers::Deduper for Deduper {
...
impl patchbay_channel_engine::resolvers::SessionBinder for SessionBinder {
    ...
    async fn ensure_session(&self, p: EnsureSessionParams) -> anyhow::Result<Uuid> {
        ...
        self.session
            .ensure_session(&patchbay_channel_engine::session::EnsureSessionInput {
...
#[async_trait]
impl patchbay_channel_engine::resolvers::Auditor for Auditor {
