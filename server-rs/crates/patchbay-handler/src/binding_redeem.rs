...
//! the Patchbay user. Token consumption, membership validation, and binding are
...
use patchbay_protocol::EVENT_DINGTALK_ACCOUNT_BINDING_UPDATED;
...
impl BindingRedeemAvailability {
    pub fn from_env() -> Self {
        Self {
            lark: valid_secret_key("PATCHBAY_LARK_SECRET_KEY"),
            slack: valid_secret_key("PATCHBAY_SLACK_SECRET_KEY"),
            wecom: valid_secret_key("PATCHBAY_WECOM_SECRET_KEY"),
            dingtalk: valid_secret_key("PATCHBAY_DINGTALK_SECRET_KEY"),
            telegram: valid_secret_key("PATCHBAY_TELEGRAM_SECRET_KEY"),
            weixin: valid_secret_key("PATCHBAY_WEIXIN_SECRET_KEY"),
        }
    }
...
fn valid_secret_key(name: &str) -> bool {
    patchbay_util::secretbox::load_key(name).is_ok()
}
