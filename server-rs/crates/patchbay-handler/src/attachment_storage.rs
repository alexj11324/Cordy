...
#[async_trait]
impl patchbay_service::channel_media_reconciler::MediaObjectDeleter for AttachmentMediaDeleter {
...
impl AttachmentStorage for S3Storage {
    ...
    fn key_from_url(&self, raw: &str) -> Option<String> {
        ...
        const MARKER: &str = "__patchbay_object_scope__";
...
impl patchbay_lark::media_ingest::MediaStorage for ChannelMediaStorage {
    fn upload(
        &self,
        key: &str,
        data: Vec<u8>,
    ...
    fn as_stream_storage(&self) -> Option<&dyn patchbay_lark::media_ingest::MediaStreamStorage> {
        self.inner.supports_streaming_uploads().then_some(self)
    }
}

#[async_trait]
impl patchbay_lark::media_ingest::MediaStreamStorage for ChannelMediaStorage {
    async fn upload_stream(
        &self,
...
#[async_trait]
impl patchbay_wecom::media_ingest::MediaStorage for ChannelMediaStorage {
    async fn upload(
        &self,
        key: &str,
        data: Vec<u8>,
    ...
    fn as_stream_storage(&self) -> Option<&dyn patchbay_wecom::media_ingest::MediaStreamStorage> {
        self.inner.supports_streaming_uploads().then_some(self)
    }
}

#[async_trait]
impl patchbay_wecom::media_ingest::MediaStreamStorage for ChannelMediaStorage {
    async fn upload_stream(
        &self,
        ctx: tokio_util::sync::CancellationToken,
        key: &str,
