...
//!
//! Remote MCP claim fields reuse the shared `patchbay-remotemcp` wire types;
...
pub type RemoteMcpTool = patchbay_remotemcp::Tool;
pub type RemoteMcpConnection = patchbay_remotemcp::Connection;
...
pub struct AgentEntry {
    ...
    pub path: String,
    /// The bare command name or PATCHBAY_*_PATH value that Path was resolved from
...
/// agent to run `patchbay attachment download <id>` instead of guessing from a
