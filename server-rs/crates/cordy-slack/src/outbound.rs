...
impl Outbound {
    ...
    async fn process_event(
        ...
        // belong only in Cordy. Outbound delivery fails closed when the origin
...
fn outbound_target(b: &cordy_db::models::ChannelChatSessionBinding) -> (String, String) {
...
mod tests {
    ...
    fn outbound_target_reads_config_channel_and_last_thread() {
        use chrono::Utc;
        let b = cordy_db::models::ChannelChatSessionBinding {
        ...
        let plain = cordy_db::models::ChannelChatSessionBinding {
