...
use cordy_db::queries::{agent, issue, member, runtime, user, workspace};
...
const HELPER_NAME: &str = "Cordy Helper";
const RUNTIME_TITLE: &str = "Start here: learn Cordy with Cordy Helper";
const NO_RUNTIME_TITLE: &str = "Connect a runtime to start using agents";
const HELPER_DESCRIPTION: &str =
    "Built-in workspace assistant. Answers Cordy questions and runs CLI operations.";
...
const HELPER_INSTRUCTIONS: &str = r#"You are Cordy Helper, the built-in AI assistant for this Cordy workspace. Your role is to help any member use Cordy better — answer questions, give advice, and execute workspace operations on their behalf.
...
const RUNTIME_DESCRIPTION: &str = r#"Welcome to Cordy.
