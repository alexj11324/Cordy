...
use patchbay_channel::message::{OutboundMessage, SendResult};
use patchbay_channel::registry::Registry;
use patchbay_channel::{BuiltChannel, Channel, Config, Factory, Type};
...
struct ChannelJobRunner {
    ...
    generation: Uuid,
    handler: Option<patchbay_channel::InboundHandler>,
    client: Arc<Client>,
    app_id: String,
    robot_code: String,
    app_key: String,
...
impl ChannelJobRunner {
    ...
    async fn run_inbound(&self, ctx: CancellationToken, msg: patchbay_channel::InboundMessage) {
...
async fn notify_issue_dispatch_error(
    ...
    app_key: &str,
    app_secret: &str,
    msg: &patchbay_channel::InboundMessage,
) {
