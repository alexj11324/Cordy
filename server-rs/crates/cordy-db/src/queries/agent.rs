//! Port of server/pkg/db/queries/agent.sql (generated agent.sql.go).
...
pub async fn merge_comment_into_pending_task(
    ...
    new_originator_user_id: Option<Uuid>,
    new_accountable_user_id: Option<Uuid>,
    new_originator_source: Option<&str>,
    new_delegated_from_task_id: Option<Uuid>,
    new_rule_version_id: Option<Uuid>,
    new_trigger_evidence_kind: Option<&str>,
    new_trigger_evidence_ref_id: Option<Uuid>,
