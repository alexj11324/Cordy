...
use cordy_db::models::ChannelMediaPendingObject;
...
pub struct ChannelMediaReconciler {
    ...
    pub metrics: Option<Arc<cordy_metrics::channel_media::ChannelMediaReconcilerMetrics>>,
...
impl ChannelMediaReconciler {
    ...
    pub async fn run_once(&self, cancel: &CancellationToken) {
        ...
        for _ in 0..SWEEP_LIMIT {
            let lease_token = cordy_db::dbid::new_v7();
