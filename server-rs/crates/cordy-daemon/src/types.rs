...
/// Provider family and custom profile must travel together: the latter owns
/// the machine-specific executable and fixed launch prefix for custom
/// runtimes, and cannot be reconstructed from a claimed task alone.
