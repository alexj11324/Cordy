...
pub(crate) const CODEX_FIRST_TURN_NO_PROGRESS_MARKER: &str =
...
pub(crate) fn classify_resume_unsafe_transport(provider: &str, err_msg: &str) -> Option<&'static str> {
...
/// resume pointer.
pub(crate) fn classify_resume_unsafe_timeout(provider: &str, err_msg: &str) -> Option<&'static str> {
