...
// Docs-local stateless Cordy mark — matches @cordy/ui's CordyIcon
...
// packages/ui/components/common/cordy-icon.tsx if the mark changes.
const CORDY_CLIP = `polygon(
...
// desktop). Leading icon = brand identity (GitHub mark / Cordy asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">Cordy Docs</span>
    ),
  },
  links: [
    {
