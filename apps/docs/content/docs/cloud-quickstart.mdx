...
Sign in on the web ([patchbay.aspectlylabs.com](https://patchbay.aspectlylabs.com)) or with [Patchbay Desktop](https://github.com/alexj11324/Cordy/releases/latest). Email verification codes and Google are both supported.
...
- [Put agents to work](/triggering-agents) — beyond setting an executor: @-mentions, chat, and Automations.
