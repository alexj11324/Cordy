...
This tutorial uses [Patchbay Desktop](https://github.com/alexj11324/Cordy/releases/latest): after downloading and signing in, it registers this computer as a runtime automatically and detects the installed AI coding tools. Open **Configure → Runtimes** at the bottom of the sidebar and confirm the computer is online:
