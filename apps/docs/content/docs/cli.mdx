...
[Cordy CLI skill](https://github.com/cordy-ai/cordy-cli) teaches those agents
...
- [Cordy CLI skill](https://github.com/cordy-ai/cordy-cli) — operate Cordy from Codex, Claude Code, or Cursor.
