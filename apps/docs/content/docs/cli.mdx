...
[Patchbay CLI skill](https://github.com/alexj11324/Cordy/blob/main/CLI_INSTALL.md) teaches those agents
...
- [Patchbay CLI skill](https://github.com/alexj11324/Cordy/blob/main/CLI_INSTALL.md) — operate Patchbay from Codex, Claude Code, or Cursor.
