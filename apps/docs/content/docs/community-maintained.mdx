...
description: Which parts of Cordy are maintained by community contributors, what that means for support, and how to report a problem in one of those areas.
---

import { Callout } from "fumadocs-ui/components/callout";

Most of Cordy is built and supported by the core team. A few areas were contributed by volunteers who stayed on as their maintainers. Those areas ship in every release, but they carry no official support SLA.
...
| --- | --- | --- | --- | --- |
| [DingTalk chat integration](/dingtalk-bot-integration) | `server-rs/crates/cordy-dingtalk` | [@yyclaw](https://github.com/yyclaw) | 2026-08 | Active |
| [WeCom chat integration](/channels) | `server-rs/crates/cordy-wecom` | [@leroy-chen](https://github.com/leroy-chen), [@seacen](https://github.com/seacen) | 2026-08 | Active |
| [Telegram chat integration](/telegram-bot-integration) | `server-rs/crates/cordy-telegram` | [@leonzone](https://github.com/leonzone) | 2026-08 | Active |
