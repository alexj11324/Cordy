...
description: Which parts of Patchbay are maintained by community contributors, what that means for support, and how to report a problem in one of those areas.
---

import { Callout } from "fumadocs-ui/components/callout";

Most of Patchbay is built and supported by the core team. A few areas were contributed by volunteers who stayed on as their maintainers. Those areas ship in every release, but they carry no official support SLA.
...
| --- | --- | --- | --- | --- |
| [DingTalk chat integration](/dingtalk-bot-integration) | `server-rs/crates/patchbay-dingtalk` | [@yyclaw](https://github.com/yyclaw) | 2026-08 | Active |
| [WeCom chat integration](/channels) | `server-rs/crates/patchbay-wecom` | [@leroy-chen](https://github.com/leroy-chen), [@seacen](https://github.com/seacen) | 2026-08 | Active |
| [Telegram chat integration](/telegram-bot-integration) | `server-rs/crates/patchbay-telegram` | [@leonzone](https://github.com/leonzone) | 2026-08 | Active |
...
File a [GitHub issue](https://github.com/patchbay-ai/patchbay/issues). Please do not DM or @-mention a maintainer directly — they agreed to be the first stop for questions **we** route to them, not a support desk anyone can page.
</Callout>
