...
description: Which parts of Orvilo are maintained by community contributors, what that means for support, and how to report a problem in one of those areas.
---

import { Callout } from "fumadocs-ui/components/callout";

Most of Orvilo is built and supported by the core team. A few areas were contributed by volunteers who stayed on as their maintainers. Those areas ship in every release, but they carry no official support SLA.
