...
Patchbay is a Go backend and pnpm monorepo. The simplest local start is `make up C=desktop`.
...
The full contributor guide — environments, worktrees, testing layers, troubleshooting and destructive reset — is [CONTRIBUTING.md](https://github.com/patchbay-ai/patchbay/blob/main/CONTRIBUTING.md) in the repository. This page is the short version.
...
database name and CLI profile under a lock and records them in `~/.patchbay/dev/`,
