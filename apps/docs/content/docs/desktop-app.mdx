...
Pick the installer that matches your OS and CPU architecture from the [latest GitHub release](https://github.com/alexj11324/Cordy/releases/latest):
...
<Callout type="warning">
Only add these exclusions if you installed Patchbay from [GitHub Releases](https://github.com/alexj11324/Cordy/releases) and the checksum matches. An exclusion disables real-time protection for everything in that folder.
</Callout>
