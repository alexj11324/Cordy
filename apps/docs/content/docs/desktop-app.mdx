...
<Callout type="info">
The CLI bundled with Desktop only serves the app's managed runtime. If you also want to run commands like `orvilo issue` in a terminal, install the CLI separately — see the [CLI reference](/cli).
</Callout>
