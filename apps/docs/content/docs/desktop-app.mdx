...
Pick the installer that matches your OS and CPU architecture from the [Patchbay downloads page](https://aspectlylabs.com/download):
...
<Callout type="warning">
Only add these exclusions if you installed Patchbay from the [downloads page](https://aspectlylabs.com/download) or [GitHub releases](https://github.com/alexj11324/Cordy/releases) and the checksum matches. An exclusion disables real-time protection for everything in that folder.
</Callout>
