...
Compare the hash with the matching line in `checksums.txt` on the [latest release](https://github.com/cordy-ai/cordy/releases/latest).
...
<Callout type="warning">
Only add these exclusions if you installed Cordy from the [downloads page](https://cordy.ai/download) or [GitHub releases](https://github.com/cordy-ai/cordy/releases) and the checksum matches. An exclusion disables real-time protection for everything in that folder.
</Callout>
