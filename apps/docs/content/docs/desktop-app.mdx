...
<Callout type="warning">
Only add these exclusions if you installed Patchbay from the [downloads page](https://patchbay.aspectlylabs.com/download) or [GitHub releases](https://github.com/patchbay-ai/patchbay/releases) and the checksum matches. An exclusion disables real-time protection for everything in that folder.
</Callout>
