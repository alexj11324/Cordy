...
function completeAssets(version: string) {
  return [
    ...
    `cordy-desktop-${version}-mac-x64.dmg`,
    `cordy-desktop-${version}-mac-x64.zip`,
    `cordy-desktop-${version}-windows-x64.exe`,
    `cordy-desktop-${version}-windows-arm64.exe`,
    `cordy-desktop-${version}-linux-x86_64.AppImage`,
    `cordy-desktop-${version}-linux-amd64.deb`,
    `cordy-desktop-${version}-linux-x86_64.rpm`,
    `cordy-desktop-${version}-linux-arm64.AppImage`,
    `cordy-desktop-${version}-linux-arm64.deb`,
    `cordy-desktop-${version}-linux-aarch64.rpm`,
  ].map((name) => ({
    name,
