    ...
    changelog: {
      ...
      entries: [
        ...
        },
        {
          ...
          fixes: [
            "오토파일럿이 비공개 에이전트와 스쿼드에 작업을 맡길 수 있습니다.",
        ...
        },
        {
          ...
          improvements: [
            ...
            "같은 태스크에서 스쿼드 리더의 후속 작업이 이전에 하던 곳부터 이어집니다.",
        ...
        },
        {
          version: "0.3.41",
          date: "2026-07-08",
          title: "머신 이름, 멤버가 만드는 스쿼드, CLI에서 태스크 정렬",
          changes: [],
          features: [
        ...
        },
        {
          ...
          fixes: [
            "프라이빗 리더 스쿼드에서 하위 태스크가 에이전트에 의해 종료될 때, 다단계 스쿼드 흐름이 첫 단계에서 멈추지 않습니다.",
        ...
        },
        {
          ...
          fixes: [
            "같은 스쿼드 내에서 하위 태스크 가 완료되면 부모 태스크 의 스쿼드 리더가 깨어나, 부모 태스크 가 in_progress 에서 멈추지 않습니다.",
        ...
        },
        {
          ...
          fixes: [
            "권한이 없는 사용자가 간접적인 태스크나 댓글 경로로 private 스쿼드 리더를 실행할 수 없게 했습니다.",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "오토파일럿이 스쿼드를 통해 새 작업을 할당하고, 생성된 태스크를 지정한 프로젝트에 바로 넣을 수 있습니다.",
          ...
          improvements: [
            "신규 사용자 런타임 연결, 런타임 페이지, 태스크 breadcrumb, HTML/첨부 미리보기, 스쿼드 보관 확인, 부모/하위 태스크 안내가 개선되었습니다.",
          ],
          fixes: [
        ...
        },
        {
          ...
          improvements: [
            "온보딩 질문 흐름, 내 태스크의 스쿼드 작업 표시, 에이전트 실행 로그 정렬이 개선되었습니다.",
          ],
          fixes: [
        ...
        },
        {
          ...
          fixes: [
            "오토파일럿 생성 태스크 반복, 런타임 기본 선택, 스쿼드 스크롤, 데스크톱 확대/축소, 인증/로컬 서비스 안정성을 수정했습니다.",
          ],
        },
        {
          version: "0.3.1",
        ...
        },
        {
          ...
          fixes: [
            "스쿼드 리더 라우팅, 스쿼드 멘션, 태스크 목록 새로고침, 첨부 미리보기 문제를 수정했습니다.",
          ],
        },
        {
          version: "0.2.32",
