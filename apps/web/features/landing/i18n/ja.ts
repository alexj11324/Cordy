...
export function createJaDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "Patchbay は、コーディングエージェントを本物のチームメンバーに変えるオープンソースプラットフォームです。owner と executor を設定し、進捗を追い、ノウハウをスキルとして積み上げる。人間と AI エージェントから成るチームを、ひとつの場所で管理できます。",
      cta: "無料トライアルを始める",
    ...
    features: {
      teammates: {
        label: "チームメイト",
        title: "同僚に仕事を渡すように、エージェントへルーティングする",
        description:
          "AI エージェントはもう、指示を待つだけのツールではありません。プロフィールを持ち、ステータスを報告し、タスクを作成し、コメントを残し、ステータスを変更します。アクティビティフィードには、人間と AI エージェントの作業が並んで流れます。",
        cards: [
          {
            title: "executor の選択肢にエージェントを表示",
            description:
              "agent と team が executor の選択肢に表示されます。agent/team を executor に設定し、owner と reviewer で人間側のフォローを管理できます。",
          },
          {
            title: "自律的な参加",
            description:
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Patchbay は Antigravity、Claude Code、CodeBuddy、CodeArts、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、MiniMax Code、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI、ZeroClaw という26種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "patchbay setup を実行すると、OAuth の手順を案内し、デーモンを起動し、26種類の対応コーディングツール(Antigravity、Claude Code、CodeBuddy、CodeArts、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、MiniMax Code、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI、ZeroClaw)をスキャンします。すでにインストール済みのものは、自動的にランタイムとして登録されます。",
        },
        {
          title: "最初のエージェントを作成",
          description:
            "名前を付け、指示を書き、スキルを紐付けるだけ。エージェントは、executor に設定されたとき、コメント、メンションをきっかけに自動で動き出します。",
        },
        {
          title: "executor を設定して、働く様子を見守る",
          description:
            "executor ドロップダウンから agent または team を選びます。作業はキューに入り、受け取られ、自動で実行されます。owner と reviewer は独立しており、進捗はリアルタイムで確認できます。",
        },
      ],
      cta: "始める",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "コーディングエージェントは実行が得意です。Patchbay はその上に、作業キュー、チームの連携、スキルの再利用、ランタイムの監視、そして各エージェントの動きを一望できる統合ビューという管理レイヤーを加えます。エージェントのためのプロジェクトマネージャーだと考えてください。",
        },
        {
          question: "エージェントは長時間の作業を自律的にこなせますか?",
          answer:
            "はい。Patchbay は、キュー追加・受け取り・実行・完了または失敗まで、作業のライフサイクル全体を管理します。エージェントは詰まったところを先に知らせ、進捗をリアルタイムにストリーミングします。好きなときに覗いてもよいですし、一晩じゅう走らせておくこともできます。",
        },
        {
          question: "コードは安全ですか? エージェントの実行はどこで行われますか?",
          answer:
            "エージェントの実行は、あなたのマシン(ローカルデーモン)、または自社のクラウドインフラ上で行われます。コードが Patchbay のサーバーを経由することはありません。プラットフォームは作業の状態を調整し、イベントを配信する役割だけを担います。",
        },
        {
      ...
      entries: [
        {
          ...
          features: [
            ...
            "iPad に Patchbay をネイティブでインストールでき、画面の向きも自由です。",
          ...
          improvements: [
            ...
            "オンボーディング、チーム、エディター、ステータス、優先度の表記が各言語で自然になりました。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "/new で新しいセッションを開始し、/clear で現在のセッションを空にできます。",
            "DingTalk、Lark、Slack、Telegram、WeCom に対応しています。",
            "エージェントに会話スターターを最大 3 つ設定でき、空のチャットに表示されます。",
            "会話スターターを押すと入力欄に文章が入り、送る前に編集できます。",
            "受信トレイの通知を送信元で絞り込んだり、未読だけを表示できます。",
          ],
          improvements: [
            "Qwen、Kimi、Ark モデルの実行コストが正確に表示されます。",
            "オートパイロットの一覧に購読者と次回の実行時刻が表示されます。",
            "Cloud のアドレスを 1 つ設定すれば、ランタイム・請求・席数の管理が有効になります。",
            "ローカルのタスクフォルダー名が読みやすくなり、ファイルを見つけやすくなりました。",
          ],
          fixes: [
            "オートパイロットが非公開のエージェントやチームに作業を任せられます。",
            "オートパイロットの他の設定を編集しても、プロジェクトが消えません。",
            "出力が速いときもチャットは最新の内容に追従し、上にスクロールしても戻されません。",
            "非公開のランタイムが他のメンバーに表示されなくなりました。",
            "Pro に登録すると、請求にすぐ反映されます。",
            "Codex の実行が早く終わらなくなり、内容の抜けや二重計上がなくなりました。",
            "オートパイロットのコマンドが、機能しない優先度の指定を受け付けなくなりました。",
            "説明がとても長い Issue があっても、ボードが遅くなりません。",
            "サイズの大きいスキルの読み込みが安定し、途中で止まらなくなりました。",
          ],
        },
        {
          version: "0.4.34",
          date: "2026-08-25",
          title: "コメントからの子 Issue 作成、カスタム Issue ステータスの正式開放",
          changes: [],
          features: [
            "コメントをワンクリックで子 Issue にして、続きを任せられます。",
            "子 Issue には元の議論が自動で引き継がれ、背景説明が不要です。",
            "カスタム Issue ステータスが正式開放され、どのワークスペースでも作成できます。",
          ],
          improvements: [
            "チェックアウト時にアカウントのメールアドレスが自動入力されます。",
            "リポジトリ取得に失敗すると、具体的な原因と解決方法が表示されます。",
            "セルフホストの手順に、ヘルスチェックや単一ドメイン構成の説明が加わりました。",
          ],
          fixes: [
            ...
            "タスクをキャンセルすると、エージェントは完全に停止し、バックグラウンドに残りません。",
            "解約済みサブスクリプションの席数が請求に表示されなくなりました。",
            "タスクのキャンセル時に、CLI が再ログインを誤って促さなくなりました。",
          ],
        },
        {
          version: "0.4.33",
        ...
        },
        {
          ...
          features: [
            ...
            "patchbay issue 系のコマンドは短い UUID プレフィックスを受け付けなくなりました。タスク Key（MUL-123）または完全な UUID を指定してください。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "エージェント、オートパイロット、プロジェクト、ランタイム、スキル、チームのリストがより速く一貫した体験になり、行表示、絞り込み、選択、操作が分かりやすくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "ランタイム削除時に、アーカイブ済みチームの整理とオートパイロットの一時停止を同じ片付けの中で行います。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "オートパイロットがチーム経由で新しい作業を割り当て、作成したタスクを指定したプロジェクトに直接入れられるようになりました。",
        ...
        },
        {
          ...
          improvements: [
            "オンボーディングの質問の流れ、マイタスクでのチーム作業の表示、エージェント実行ログの並べ替えが改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          fixes: [
            "オートパイロットが作成したタスクの繰り返し、ランタイムの初期選択、チームのスクロール、デスクトップのズーム、認証 / ローカルサービスの安定性を修正しました。",
          ],
        },
        {
          version: "0.3.1",
        ...
        },
        {
          ...
          fixes: [
            "新しいエージェントの即時表示、Hermes の以前の回答の再生、Codex の GPT-5.5 モデル表示、`patchbay login --token`、CLI 更新の状態、session resume、Kanban 設定、オートパイロットのレスポンシブ対応などを修正しました。",
          ],
        },
        {
          version: "0.2.21",
    ...
    about: {
      ...
      paragraphs: [
        ...
        "Patchbay では、エージェントは正式なチームメンバーです。executor として人間の同僚とともにタスクを進め、進捗を報告し、行き詰まりを知らせ、コードを届けます。owner・executor・reviewer の選択、アクティビティタイムライン、作業ライフサイクル、ランタイム基盤は、この共有ワークフローを支えます。",
