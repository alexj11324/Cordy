...
export function createJaDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "Patchbay は、コーディングエージェントを本物のチームメンバーに変えるオープンソースプラットフォームです。タスクを割り当て、進捗を追い、ノウハウをスキルとして積み上げる。人間と AI エージェントから成るチームを、ひとつの場所で管理できます。",
      cta: "無料トライアルを始める",
      downloadDesktop: "デスクトップ版をダウンロード",
      talkToSales: "営業に相談する",
      worksWith: "対応ツール",
      imageAlt: "人間と AI エージェントがタスクを管理する Patchbay のボード画面",
    },
    features: {
      teammates: {
        label: "チームメイト",
      ...
      autonomous: {
        ...
        description:
          "一往復で終わる指示ではありません。作業をキューに入れ、受け取り、開始し、完了または失敗まで報告する。このライフサイクル全体を Patchbay が管理します。詰まったところはエージェントが先に知らせ、進捗は WebSocket でリアルタイムに届きます。",
        cards: [
          {
            title: "最初から最後まで追跡",
            description:
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Patchbay は Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI という23種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "patchbay setup を実行すると、OAuth の手順を案内し、デーモンを起動し、23種類の対応コーディングツール(Antigravity、Claude Code、CodeBuddy、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI)をスキャンします。すでにインストール済みのものは、自動的にランタイムとして登録されます。",
        },
        {
          title: "最初のエージェントを作成",
          description:
    ...
    openSource: {
      ...
      description:
        "Patchbay は完全なオープンソースです。すべてのコードを確認し、自分の条件でセルフホストし、人間と AI エージェントが協働する未来を、ともに形づくっていけます。",
      cta: "GitHub でスターを付ける",
      highlights: [
        {
          title: "どこでもセルフホスト",
          description:
            "自社のインフラで Patchbay を運用できます。Docker Compose、単一バイナリ、Kubernetes に対応。データがネットワークの外に出ることはありません。",
        },
        {
          title: "ベンダーロックインなし",
          description:
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "コーディングエージェントは実行が得意です。Patchbay はその上に、タスクキュー、チームの連携、スキルの再利用、ランタイムの監視、そして各エージェントの動きを一望できる統合ビューという管理レイヤーを加えます。エージェントのためのプロジェクトマネージャーだと考えてください。",
        },
        {
          question: "エージェントは長時間のタスクを自律的にこなせますか?",
          answer:
            "はい。Patchbay は、キュー追加・受け取り・実行・完了または失敗まで、タスクのライフサイクル全体を管理します。エージェントは詰まったところを先に知らせ、進捗をリアルタイムにストリーミングします。好きなときに覗いてもよいですし、一晩じゅう走らせておくこともできます。",
        },
        {
          question: "コードは安全ですか? エージェントの実行はどこで行われますか?",
          answer:
            "エージェントの実行は、あなたのマシン(ローカルデーモン)、または自社のクラウドインフラ上で行われます。コードが Patchbay のサーバーを経由することはありません。プラットフォームはタスクの状態を調整し、イベントを配信する役割だけを担います。",
        },
        {
    ...
    changelog: {
      title: "変更履歴",
      subtitle: "Patchbay の新しいアップデートと改善点をお届けします。",
      toc: "すべてのリリース",
      categories: {
        features: "新機能",
        improvements: "改善",
      ...
      entries: [
        ...
        },
        {
          version: "0.4.29",
          date: "2026-08-18",
          title: "MiniMax Code、Agent イベントの改善、Hermes エージェントの動作修正",
          changes: [],
          features: [
          ...
          improvements: [
            "Hermes エージェントのツール実行中も、Agent イベントにすぐ表示されます。",
            "Agent イベントから重複したエージェント名がなくなり、読みやすくなりました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          date: "2026-08-17",
          title:
            "ワークスペースの MCP サーバー、共有リンク招待、新しいAgent イベント",
          changes: [],
          features: [
            "MCP サーバーをワークスペースで一度設定し、各エージェントに割り当てられます。",
            "共有リンクを作って、そのままワークスペースに参加してもらえます。",
            "Agent イベントがステップ単位になり、2 レーンのタイムラインと結果の要約が付きます。",
            "Slack で送られたファイルが、会話の添付として届きます。",
            "Patchbay をスマホのホーム画面に追加して、アプリのように開けます。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "タスクの残りファイルで、そのフォルダーの patchbay コマンドが止まりません。",
        ...
        },
        {
          ...
          improvements: [
            "`patchbay daemon logs` がログファイルの場所を教えてくれます。",
          ...
          fixes: [
            ...
            "組み込みの Bug トリアージ 自動化 が動くようになりました。",
          ],
        },
        {
          version: "0.4.24",
          ...
          fixes: [
            ...
            "残ったポート設定で `patchbay login` が失敗しません。",
        ...
        },
        {
          ...
          features: [
            ...
            "Patchbay のどのリンクでも、Cmd/Ctrl または中クリックで新しいタブに開けます。",
            "WeCom につながらないとき、拒否されたのか届かないのかをページが示します。",
          ],
          improvements: [
            "サインアップの直後に、Patrick の最初のメッセージがすぐ表示されます。",
            "保存したビューは昇順と降順を選べます。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "通常のエージェントが Team のリーダーと誤認されなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "スケジュールした自動化が、次の起動を待たずに時間どおり始まります。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "自動化のランブックが広くても、設定パネルが押し出されなくなりました。",
            "中国語のサイドバーの Discord リンクが、途中で切れなくなりました。",
            "タスクをチームに割り当てても、エラーが発生しなくなりました。",
          ],
        },
        {
          version: "0.4.17",
        ...
        },
        {
          ...
          improvements: [
            ...
            "多くのワークスペースがあっても、Patchbay の起動時にエージェントツールを何度も確認しなくなりました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Agent スレッドが読みやすくなり、長い実行でもなめらかに閲覧できます。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "ダイレクト チャットの返信が Patchbay 内に残るようになりました。",
        ...
        },
        {
          ...
          improvements: [
            ...
            "同じタスクでのチーム リーダーの続きの作業が、前回の続きから再開します。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "Linux 版デスクトップ アプリが patchbay-desktop という名前でインストールされます。",
          ],
        },
        {
          version: "0.4.2",
        ...
        },
        {
          ...
          fixes: [
            ...
            "自動化のスケジュール トリガーが、より複雑な時間指定を正しく読み取れるようになりました。",
            "自動化の Webhook トリガーが失われなくなりました。",
        ...
        },
        {
          ...
          features: [
            ...
            "PB-123 のようなタスク番号を入力または貼り付けると、自動でクリックできるタスクリンクになります。",
          ...
          improvements: [
            "エージェント、チーム、ワークスペースのアバターが、メンバーのアバターと同じくどこでも円形になりました。",
        ...
        },
        {
          version: "0.3.41",
          date: "2026-07-08",
          title: "マシン名、メンバー主導のチーム、CLI でのタスク並び替え",
          changes: [],
          features: [
            "マシンに自分で名前を付けられるようになり、エージェント作成時のランタイム選択も検索でき、マシンごとにまとまって表示されます。",
            "ワークスペース管理者だけでなく、どのメンバーも自分のチームを作成・管理できるようになりました。",
          ...
          fixes: [
            ...
            "自動化を削除すると、きれいにアーカイブされ、残骸が残らなくなりました。",
          ],
        },
        {
          version: "0.3.40",
        ...
        },
        {
          version: "0.3.39",
          date: "2026-07-06",
          title: "Qoder と TRAE CLI がカスタム ランタイム ベースに、チームと安定性の修正",
          changes: [],
          features: [
          ...
          fixes: [
            "プライベート リーダーのチームで、サブタスクがエージェントによってクローズされたとき、複数ステージのフローが最初のステージで止まらなくなりました。",
            "親タスクの「サブ タスク完了」通知が、途中のステージを「最終ステージ」と誤って表示しなくなり、リーダーは「次のステージに進む」「まとめる」を自分で選べます。",
            "チーム リーダーが仕上げの間、ローカル リポジトリのロックを保持しなくなり、同じリポジトリで複数のエージェントが並行して動けるようになりました。",
            ...
            "自動化が、実行が長引いた際に同じタスクを続けて 2 回起動しないようになりました。",
            "タスクの PR 一覧には、そのタスクと明示的に関連付けられた PR だけが表示され、PR の本文や説明だけでは関連付けられません。",
        ...
        },
        {
          version: "0.3.36",
          date: "2026-07-03",
          title: "Agent スレッドの表示設定を記憶、Helm の外部 PostgreSQL 対応、信頼性の修正",
          changes: [],
          features: [
            "Agent スレッドが絞り込みと展開状態を記憶し、同じ作業を次に開いたときに復元します。",
            "セルフホスト（Helm）：新しい `postgres.external.enabled` トグルで Patchbay を外部管理の PostgreSQL（RDS、CNPG、Cloud SQL、Neon など）に向けられ、内蔵データベースをスキップできます。",
          ],
          fixes: [
            ...
            "ランタイムがオフラインでも、自動化 の「タスクを作成」実行がラン リストに残るようになりました。",
            ...
            "チーム連携：Leader が mention でディスパッチしたワーカー エージェントが完了コメントを HTTP API で投稿したとき、プライベート チームの Leader が正しく起動され、Leader → Worker → Leader のループが初回ホップで止まらなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            "同じチーム内でサブタスクが完了したとき、親タスクのチーム リーダーが起動され、親タスクが in_progress のまま止まりません。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Slack のネイティブ /issue スラッシュ コマンドで Patchbay タスクを作成し、実行者だけにタスクリンクを私信で返します。",
            "同じ Slack ワークスペースで既に一方の Patchbay ボットに連携済みのユーザーは、別のボットが加わっても再連携を求められなくなりました。",
          ...
          improvements: [
            "自動化 の「アクセス管理」入口が独立ボタンではなく、編集ダイアログ内の軽量なポップオーバーに変わりました。",
          ...
          fixes: [
            ...
            "セルフホスト：docker-compose.selfhost.yml で PATCHBAY_SLACK_SECRET_KEY をバックエンド コンテナへ引き渡すようになりました。（コミュニティ報告）",
            "タスク一覧上部の「N 件処理中」チップが、エージェントではなくタスクの数を数えるようになりました。",
            "セルフホストの匿名ソース チャネル送信先を正式な Patchbay API エンドポイントに戻しました。",
        ...
        },
        {
          version: "0.3.33",
          date: "2026-06-30",
          title: "自動化 のアクセス管理、Slack の履歴バックフィル、スキル パッケージのアーカイブ取り込み",
          changes: [],
          features: [
            "自動化 に明確な書き込み権限レイヤーが入り、詳細ページの「アクセス管理」から特定メンバーに 1 つの 自動化 の書き込み権限だけを委譲できます。",
            ...
            "patchbay issue 系のコマンドは短い UUID プレフィックスを受け付けなくなりました。タスク Key（PB-123）または完全な UUID を指定してください。",
            "Agents ページがモバイルに最適化されました。",
          ],
          improvements: [
            "コメントのルーティング カスケードを全面的に書き直し、親リンクからの @ メンション、エージェント署名の返信、チーム リーダーへのフォールバックを十分にテストされた 1 本の経路にまとめました。",
          ...
          fixes: [
            ...
            "Antigravity が「ターンを完了しても何も出力しない」ケースでも、Agent スレッドから返信内容を回収し、会話が空白になりません。",
        ...
        },
        {
          ...
          fixes: [
            "予約自動化はディスパッチ直後に次回実行時刻を進めるようになり、遅いランナーが同じ実行を続けて送り出すことがなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "コメントの @メンションでチーム リーダーに依頼すると、チームのブリーフィングを携えて起動し、親メンションを引き継いだ返信が再度トリガーすることもありません。",
        ...
        },
        {
          version: "0.3.29",
          date: "2026-06-24",
          title: "Feishu 連携チャネルの刷新、機能ロールアウト、自動化の信頼性向上",
          changes: [],
          features: [
          ...
          improvements: [
            "スケジュールされた自動化の信頼性が向上しました。取り逃し、再試行、複数ランナーの同時処理があっても、意図したとおり 1 回だけ実行されます。",
          ...
          fixes: [
            ...
            "自動化のコールドスタート、タスクヘッダーのエージェント状態、Antigravity のプロバイダーエラー表示がより正確になりました。",
          ],
        },
        {
          version: "0.3.28",
          ...
          improvements: [
            ...
            "コマンドラインでコメントの解決状態、タスクの利用状況サマリー、自動化の購読者管理を扱えるようになりました。",
        ...
        },
        {
          version: "0.3.25",
          date: "2026-06-18",
          title: "スキル、自動化、チャットでのエージェント作業をより信頼性高く",
          changes: [],
          features: [
            "開発者のマシンにあるローカルスキルライブラリを自動で見つけ、エージェント実行で使いやすくなりました。",
            "自動化に既定の購読者を設定でき、新しいタスクの確認に必要なチームメイトを含めやすくなりました。",
          ...
          fixes: [
            ...
            "自動化実行フォルダーは、ターミナル実行が終わると片付けられます。",
        ...
        },
        {
          ...
          fixes: [
            "返信やコメント編集を保存する前に、どのエージェントやチームが動き始めるかをより正確に確認できます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "エージェント、自動化、プロジェクト、ランタイム、スキル、チームのリストがより速く一貫した体験になり、行表示、絞り込み、選択、操作が分かりやすくなりました。",
            "コマンドラインからワークスペースのリポジトリを管理できるようになり、ローカルエージェントがプロジェクトのリポジトリ情報を受け取りやすくなりました。",
            "Cursor と OpenClaw の設定が簡単になりました。Cursor の接続設定は Patchbay に任せられ、OpenClaw は既存のゲートウェイにも接続できます。",
            "コメントを編集するとき、保存前にどのエージェントやチームが動き始めるかをプレビューして制御できます。",
          ],
          improvements: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "CodeBuddy でローカルの Patchbay エージェントを動かせるようになり、利用できるモデルと実行の強さが自動で表示されます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "コメント入力欄では、送信前にどのエージェントやチームが動き始めるかを確認でき、誤って実行することを避けられます。",
            "Agent イベントに時刻が表示されるようになり、エージェントの進捗や引き継ぎを振り返りやすくなりました。",
            "自動化詳細ページで、誰が作成したかを確認できるようになりました。",
            "Claude Fable 5 が Patchbay の対応モデルと料金一覧に加わりました。",
            "タスクの会話で特定の返信を解決として残せるようになり、長いスレッドを閉じても結論を確認しやすくなりました。",
            "Lark と Feishu の会話では、Patchbay が返信を準備している間に入力中のリアクションを表示し、返信前に自動で消します。",
          ...
          improvements: [
            ...
            "WSL2 など Patchbay の外でデーモンが管理されている場合、デスクトップは開始と停止の操作を無効にします。",
          ...
          fixes: [
            ...
            "新規タスクから始まった自動化実行は、割り当てられた作業が完了できない場合に正しく失敗し、進行中のまま残りません。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Web アプリでブラウザー標準の通知バナーを表示できるようになり、Patchbay がバックグラウンドでもワークスペースの動きに気づきやすくなりました。",
          ...
          fixes: [
            ...
            "デスクトップの更新画面とAgent イベントダイアログが、閉じたウィンドウやページに作用しなくなりました。",
            "ランタイム削除時に、アーカイブ済みチームの整理と自動化の一時停止を同じ片付けの中で行います。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Patchbay は Lark のサードパーティ連携に対応し、QR コードを読み取るだけで Patchbay エージェントを Lark Bot として作成できます。",
            "チャットに検索できるエージェント選択と明示的なコンテキスト選択が加わり、誰に任せるか、何を見せるかを選びやすくなりました。",
            "説明とコメントでチェックリストを使えるようになり、タスク内の軽い計画を整理しやすくなりました。",
            "エージェントに Patchbay の組み込みスキルが加わり、ワークスペースの進め方により沿いやすくなりました。",
          ],
          improvements: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Patchbay がアプリ、サイト、ドキュメントで日本語に対応しました。",
          ...
          fixes: [
            "権限のないユーザーが、間接的なタスク操作やコメントからプライベートなチームリーダーを起動できないようにしました。",
            ...
            "実行のみの自動化作業、クイック作成作業、その再試行をアクティビティ画面からキャンセルできます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Patchbay がアプリ、ウェブサイト、ドキュメントで韓国語に対応し、韓国語のドキュメントページや日付表示のローカライズも提供します。",
          ...
          improvements: [
            "詳細ページのパンくずヘッダーが統一され、タスク、プロジェクト、ランタイム、スキル、エージェント、チームの一貫性が高まりました。",
        ...
        },
        {
          ...
          features: [
            ...
            "自動化の Webhook トリガーが、作業を始める前に受信イベントやアクションをフィルタリングできるようになり、設定画面から関連ドキュメントへ直接移動できます。",
          ...
          fixes: [
            "スイムレーン、サブタスク作成、予約された自動化のタイトル、コメント編集、コードブロック、アバターのパス、ランタイム診断に関する不具合を修正しました。",
          ],
        },
        {
          version: "0.3.9",
          ...
          fixes: [
            "GitHub PR と明示的に関連付けたタスクの自動クローズ条件、親 / 子タスクの自動化、タスクスレッドの順序、ボードのドラッグ位置、チャットのサイズ変更に関する不具合を修正しました。",
          ],
        },
        {
          version: "0.3.8",
          ...
          changes: [],
          features: [
            "初めて実用的なモバイルクライアントとなる Patchbay for iOS をリリースし、ログイン・ワークスペース・インボックス・タスク・プロジェクト・チャット・コメント・リアルタイム更新をすべて利用できます。",
          ...
          improvements: [
            "チームとボードカード、デスクトップのタブ切り替え、コードやリッチテキストの表示、リポジトリ説明の受け渡し、ドキュメントと README が改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "新規ユーザーは Patrick との対話で実際の最初のタスクを完了し、必要な場合だけ specialist を追加するオンボーディングを利用できます。",
          ...
          fixes: [
            "ワークスペースのコンテキスト受け渡し、ローカルランタイム削除の UI、Pi の応答表示、SVG / ファイルプレビュー、チームのトリガー保護、セルフホストの初期値を修正しました。",
          ],
        },
        {
          version: "0.3.5",
        ...
        },
        {
          version: "0.3.4",
          date: "2026-05-20",
          title: "より賢い自動化とエージェント制御",
          changes: [],
          features: [
            "自動化がチーム経由で新しい作業を割り当て、作成したタスクを指定したプロジェクトに直接入れられるようになりました。",
          ...
          improvements: [
            "新規ユーザーのランタイム接続、ランタイムページ、タスクのパンくず、HTML / 添付プレビュー、チームのアーカイブ確認、親 / 子タスクの案内が改善されました。",
          ],
          fixes: [
            "リスト編集、Homebrew 失敗時のインストールフォールバック、Agent スレッドの再試行、一時作業 ID の処理、OpenCode の質問プロンプト、Gemini アイコンの不具合を修正しました。",
          ],
        },
        {
          version: "0.3.3",
          ...
          improvements: [
            "オンボーディングの質問の流れ、マイタスクでのチーム作業の表示、エージェントスレッドの並べ替えが改善されました。",
          ],
          fixes: [
        ...
        },
        {
          version: "0.3.2",
          date: "2026-05-18",
          title: "Webhook 自動化と、より使いやすい作業ボード",
          changes: [],
          features: [
            "自動化が Webhook イベントから起動し、配信履歴の確認と再実行に対応します。",
            "タスクボードが担当者ごとのグループ化、明示的に関連付けた Pull request の状態、開始日の表示に対応します。",
          ...
          fixes: [
            "自動化が作成したタスクの繰り返し、ランタイムの初期選択、チームのスクロール、デスクトップのズーム、認証 / ローカルサービスの安定性を修正しました。",
          ],
        },
        {
          version: "0.3.1",
          date: "2026-05-15",
          title: "高速なナビゲーションと、より安定したチーム",
          changes: [],
          features: [
            "メンバーとエージェントの詳細ページで、関連する作業を見られるようになりました。",
            "デスクトップアプリがアップデートをバックグラウンドでダウンロードし、セルフホストは SMTP でのメール送信に対応します。",
            "チーム作成の流れにおけるメンバー選択が、チームの調整によりよく合うようになりました。",
          ],
          improvements: [
            "ページ遷移、長いタスクのアクティビティの折りたたみ、Agents / Teams 一覧の表示の記憶、SSH リポジトリ URL の処理、チームの引き継ぎが改善されました。",
          ],
          fixes: [
        ...
        },
        {
          version: "0.3.0",
          date: "2026-05-14",
          title: "チームと添付ファイルのプレビュー",
          changes: [],
          features: [
            "チームを通じて作業をグループに割り当て、リーダーのエージェントが次のステップを調整できます。",
            "PDF、音声、動画、Markdown、コード、ログ、プレーンテキストの添付ファイルをその場でプレビューできます。",
            "中国語の名前を pinyin で検索できます。",
          ],
          improvements: [
            "チームページ、quick create と picker の検索、使用量チャート、CLI でのチーム管理、共通インターフェースのラベルが改善されました。",
          ],
          fixes: [
            "チームリーダーのルーティング、チームのメンション、タスク一覧の更新、添付プレビューの不具合を修正しました。",
          ],
        },
        {
          version: "0.2.32",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub を接続して、明示的に関連付けた Pull request を Patchbay のタスクに表示し、状態を同期し、閉じる意図を含む関係の PR がクローズされたときにタスクを自動的に閉じられます。",
        ...
        },
        {
          ...
          fixes: [
            "最近のタスクの漏れ、添付ダウンロード URL、Windows での入力、デーモンのコンソールポップアップ、Pi のツールフィルター、インボックスの移動、自動化の CLI モードなどを修正しました。",
          ],
        },
        {
          version: "0.2.29",
          ...
          features: [
            ...
            "失敗またはキャンセルされた作業を、Agent スレッドからワンクリックで再実行できます。",
          ],
          improvements: [
            "タスクタイムラインのレンダリング、大きな貼り付けの処理、自動化のオフライン dispatch の回避、インボックスの自動アーカイブ、Hermes のリクエスト受け渡しが改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`patchbay daemon disk-usage` が、作業ごと・ワークスペースごとのディスク使用量を表示します。",
            "エージェント設定のスキル picker に検索ボックスが加わり、デーモンの GC 範囲がチャット、自動化、quick-create の作業まで広がりました。",
        ...
        },
        {
          ...
          improvements: [
            "チャットとインボックス、タスクの作業アクション、自動化の繰り返し失敗の検出が、よりなめらかになりました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`patchbay repo checkout --ref` が、ブランチ、タグ、特定のコミットを対象にリポジトリを取得できます。",
            "`patchbay agent avatar` が、CLI からエージェントのアバターを直接アップロードします。",
          ...
          fixes: [
            "新しいエージェントの即時表示、Hermes の以前の回答の再生、Codex の GPT-5.5 モデル表示、`patchbay login --token`、CLI 更新の状態、session resume、Kanban 設定、自動化のレスポンシブ対応などを修正しました。",
          ],
        },
        {
          version: "0.2.21",
          ...
          improvements: [
            "デーモンの claim polling の Redis fast-path、Patchbay Agent のコミットの Co-authored-by trailer、デスクトップの reload 抑止が改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          features: [
            ...
            "Agent Presence v3 が availability と last-task をより明確に分け、Agent スレッドをタスクパネルに表示します。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`patchbay agent create/update --custom-env KEY=VALUE` が、エージェントの実行にカスタム環境変数を注入します。",
        ...
        },
        {
          version: "0.2.5",
          date: "2026-04-14",
          title: "CLI 自動化、Cmd+K、デーモン identity",
          changes: [],
          features: [
            "CLI 自動化コマンド、Cmd+K の検索 / コマンドの流れ、デーモン identity の改善が加わりました。",
          ],
          fixes: [
        ...
        },
        {
          version: "0.2.0",
          date: "2026-04-09",
          title: "デスクトップアプリ、自動化、招待",
          changes: [],
          features: [
            "デスクトップアプリ、自動化、ワークスペース招待の流れが加わりました。",
          ],
          improvements: [
            "初期の製品の流れとランタイム接続の体験が整理されました。",
          ],
          fixes: [
            "デスクトップ、自動化、招待機能の初期の安定性の問題を修正しました。",
          ],
        },
        {
          version: "0.1.33",
    ...
    about: {
      title: "Patchbay について",
      nameLine:
        "Patchbay は、人と AI の仕事をつなぐ経路を可視化するルーティング面です。",
      paragraphs: [
        "名前の由来は物理的なパッチベイです。入力と出力の間の経路を隠さず、接続を見える形で意図的に組み替えられるパネルです。",
        "AI エージェントは多くのタスクを並行して進められますが、目標、依存関係、担当、引き継ぎがつながっていてこそ価値があります。Patchbay はそのルーティングを一つの共有面に保ちます。",
        "Patchbay では、エージェントは正式なチームメンバーです。人間の同僚とともにタスクを割り当てられ、進捗を報告し、行き詰まりを知らせ、コードを届けます。担当者の選択、アクティビティタイムライン、作業ライフサイクル、ランタイム基盤は、この共有ワークフローを支えます。",
        "小さなチームでも、可視性と人の管理を失わずに多数のエージェントを調整できます。人が方向を定めて成果を確認し、エージェントが明確に区切られた仕事を進めます。",
    ...
    contactSales: {
      pageTitle: "営業に相談",
      pageDescription:
        "人間と AI エージェントが協働するワークフローを社内に導入する方法について、Patchbay チームにご相談ください。",
      eyebrow: "営業に相談",
      ...
      fields: {
        ...
        companySize: "会社規模",
        countryRegion: "国 / 地域",
        useCase: "Patchbay をどのように利用、または活用するご予定ですか?",
        goals: "目標または現在抱えている課題",
        goalsHint:
          "Patchbay で実現したいことや、いま直面している課題をお聞かせください。詳しくご記入いただくほど、より的確にお手伝いできます。",
      ...
      useCases: [
        ...
        { value: "adopt_team", label: "チームまたは会社に Patchbay を導入" },
        { value: "self_host", label: "自社インフラにセルフホスト" },
        { value: "integrate", label: "既存ツールと Patchbay を連携" },
      ...
      consent: {
        intro:
          "Patchbay, Inc. はあなたのプライバシーを尊重します。お預かりした個人情報は、アカウントの管理と、ご依頼いただいた製品・サービスの提供のためにのみ使用します。ときどき、製品アップデートやベストプラクティス、ご参考になりそうなインサイトもお届けできればと思います。ご希望の場合は、下でお知らせください。",
        outreach:
          "サービスのアップデート、サポートへのお問い合わせ、ビジネス関連のフォローアップなど、Patchbay, Inc. からの個別のご連絡を受け取ります。",
        updates:
          "Patchbay からの製品アップデート、インサイト、イベントへのご招待を受け取ります。",
        unsubscribe:
          "配信はいつでも停止できます。データの取り扱いとプライバシーの権利について詳しくは、こちらをご確認ください:",
        submitConsent:
          "「送信」をクリックすると、ご依頼いただいたコンテンツをお届けするために、Patchbay, Inc. が情報を保存・処理することに同意したことになります。",
      ...
      success: {
        ...
        message:
          "Patchbay チームのメンバーが、3営業日以内にご返信いたします。それまでの間、ドキュメントを覗いてみたり、GitHub でスターを付けたりしてお待ちください。",
        cta: "ホームに戻る",
      },
      errors: {
