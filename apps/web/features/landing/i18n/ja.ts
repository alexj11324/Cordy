      ...
      entries: [
        ...
        },
        {
          ...
          fixes: [
            ...
            "タスクの PR 一覧には、そのタスクを実際に対象にしている PR だけが表示され、本文で「Related to PB-…」と触れているだけの PR は非表示になりました。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "GitHub を接続して、連携した Pull request を Patchbay のタスクに表示し、状態を同期し、PR がクローズされたときにタスクを自動的に閉じられます。",
