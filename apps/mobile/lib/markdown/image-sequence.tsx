/**
 * Screen-scoped image sequence for the lightbox (PB-5752).
 *
 ...
 * clients call `collectImageSequence` from @cordy/core so an issue's images
...
} from "@cordy/core/attachments/image-sequence";
