...
import type { Issue, IssueStatusEntry } from "@cordy/core/types";
import {
  BOARD_CATEGORIES,
  CLOSED_CATEGORIES,
...
describe("issueColumnCategory", () => {
  ...
  // which is the bug this file exists to prevent (PB-6457).
...
describe("issueBehavesAs", () => {
  ...
  // status inherits its category's behavior in full. (PB-6243)
