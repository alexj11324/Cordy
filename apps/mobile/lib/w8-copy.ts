...
const EN: W8Copy = {
  ...
  wecom: {
    ...
    notEnabledDescription: "Ask your Orvilo operator to enable WeCom for this deployment.",
    ...
    previewDescription: "Connect a bot from the WeCom admin console to route messages to an Orvilo agent.",
    ...
    disconnectDescription: "New messages from this bot will stop reaching Orvilo.",
    cancel: "Cancel",
  ...
  bind: {
    ...
    signInRequired: "Sign in to Orvilo, then open the WeCom link again to finish linking your account.",
    signIn: "Sign in",
    redeeming: "Linking your WeCom account…",
    successTitle: "WeCom account linked",
    successDescription: "Your WeCom account is now linked to your Orvilo account.",
    expired: "This link is invalid or has expired. Ask WeCom for a new link.",
    conflict: "This WeCom account is already linked to another Orvilo user.",
    notMember: "Your Orvilo account is not a member of the target workspace.",
...
const JA: W8Copy = {
  ...
  wecom: {
    ...
    notEnabledDescription: "この環境でWeComを有効にするようOrviloの管理者に依頼してください。",
    unsupportedTitle: "WeComのインストールは利用できません",
    unsupportedDescription: "既存のボットは表示できますが、新しいボットは接続できません。",
    previewTitle: "WeComスマートボット",
    previewDescription: "WeCom管理コンソールのボットを接続し、メッセージをOrviloエージェントに送ります。",
    ...
    disconnectDescription: "このボットからの新しいメッセージはOrviloに届かなくなります。",
    cancel: "キャンセル",
    connecting: "接続中…",
    installed: "インストール済み",
    revoked: "解除済み",
  ...
  bind: {
    ...
    signInRequired: "Orviloにサインインしてから、WeComリンクをもう一度開いてリンクを完了してください。",
    signIn: "サインイン",
    redeeming: "WeComアカウントをリンク中…",
    successTitle: "WeComアカウントをリンクしました",
    successDescription: "WeComアカウントがOrviloアカウントにリンクされました。",
    expired: "このリンクは無効か期限切れです。WeComから新しいリンクを取得してください。",
    conflict: "このWeComアカウントは別のOrviloユーザーにリンクされています。",
    notMember: "Orviloアカウントは対象ワークスペースのメンバーではありません。",
...
const KO: W8Copy = {
  ...
  wecom: {
    ...
    notEnabledDescription: "이 배포에서 WeCom을 활성화하도록 Orvilo 운영자에게 요청하세요.",
    unsupportedTitle: "WeCom 설치를 사용할 수 없습니다",
    unsupportedDescription: "기존 봇은 볼 수 있지만 새 봇을 연결할 수 없습니다.",
    previewTitle: "WeCom 스마트 봇",
    previewDescription: "WeCom 관리자 콘솔의 봇을 연결해 메시지를 Orvilo 에이전트로 전달하세요.",
    connectedBots: "연결된 봇",
    ...
    disconnectDescription: "이 봇의 새 메시지는 Orvilo에 도착하지 않습니다.",
    cancel: "취소",
    connecting: "연결 중…",
    installed: "설치됨",
    revoked: "해제됨",
  ...
  bind: {
    ...
    signInRequired: "Orvilo에 로그인한 뒤 WeCom 링크를 다시 열어 계정 연결을 완료하세요.",
    signIn: "로그인",
    redeeming: "WeCom 계정 연결 중…",
    successTitle: "WeCom 계정이 연결되었습니다",
    successDescription: "WeCom 계정이 Orvilo 계정에 연결되었습니다.",
    expired: "링크가 유효하지 않거나 만료되었습니다. WeCom에서 새 링크를 요청하세요.",
    conflict: "이 WeCom 계정은 다른 Orvilo 사용자에게 이미 연결되어 있습니다.",
    notMember: "Orvilo 계정이 대상 워크스페이스의 멤버가 아닙니다.",
...
const ZH_HANS: W8Copy = {
  ...
  wecom: {
    ...
    notEnabledDescription: "请联系 Orvilo 运营方为此部署启用企业微信。",
    unsupportedTitle: "企业微信安装不可用",
    unsupportedDescription: "可以查看已有机器人，但此部署无法连接新机器人。",
    previewTitle: "企业微信智能机器人",
    previewDescription: "从企业微信管理后台连接机器人，将消息路由到 Orvilo Agent。",
    ...
    disconnectDescription: "此机器人发来的新消息将不再进入 Orvilo。",
    cancel: "取消",
    connecting: "连接中…",
    installed: "已安装",
    revoked: "已断开",
  ...
  bind: {
    ...
    signInRequired: "请先登录 Orvilo，再重新打开企业微信链接完成绑定。",
    signIn: "登录",
    redeeming: "正在绑定企业微信账号…",
    successTitle: "企业微信账号已绑定",
    successDescription: "你的企业微信账号现在已关联到 Orvilo 账号。",
    expired: "此链接无效或已过期，请从企业微信获取新链接。",
    conflict: "此企业微信账号已绑定到其他 Orvilo 用户。",
    notMember: "你的 Orvilo 账号不是目标工作区成员。",
