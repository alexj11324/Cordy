 ...
 *
 * Types are imported via `import type` from @orvilo/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @orvilo/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
 ...
 *  reasonable Orvilo payload size on cellular. */
...
class ApiClient {
  ...
  async clerkLogin(sessionToken: string): Promise<LoginResponse> {
    return this.fetch<LoginResponse>("/auth/clerk", {
      method: "POST",
