 ...
 * yet schematised in @cordy/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@cordy/core/api/schemas";
...
// availability derivation in @cordy/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@cordy/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
