export const ISSUE_WINDOW_ARGUMENT_PREFIX = "--orvilo-issue-window=";
...
export function parseIssueWindowPath(
  ...
  let url: URL;
  try {
    url = new URL(value, "https://desktop.orvilo.invalid");
  } catch {
    return null;
  }
  if (url.origin !== "https://desktop.orvilo.invalid") return null;
