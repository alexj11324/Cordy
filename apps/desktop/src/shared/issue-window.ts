export const ISSUE_WINDOW_ARGUMENT_PREFIX = "--cordy-issue-window=";
...
export function parseIssueWindowPath(
  ...
  let url: URL;
  try {
    url = new URL(value, "https://desktop.cordy.invalid");
  } catch {
    return null;
  }
  if (url.origin !== "https://desktop.cordy.invalid") return null;
