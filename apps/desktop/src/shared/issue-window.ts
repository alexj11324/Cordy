export const ISSUE_WINDOW_ARGUMENT_PREFIX = "--patchbay-issue-window=";
...
export function parseIssueWindowPath(
  ...
  let url: URL;
  try {
    url = new URL(value, "https://desktop.patchbay.invalid");
  } catch {
    return null;
  }
  if (url.origin !== "https://desktop.patchbay.invalid") return null;
