...
// Convention: api hosts are exposed at `api.<web-host>` (api.aspectlylabs.com →
// aspectlylabs.com, api.test.aspectlylabs.com → test.aspectlylabs.com). Strip the leading
