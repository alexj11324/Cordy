import { CircleUser, Columns3, Filter, ListTodo, MoreHorizontal, Plus, SlidersHorizontal } from "lucide-react";
...
export function DesktopWebPreviewIssuesPage() {
  const { t } = useT("issues");
