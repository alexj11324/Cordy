...
/**
 * Two regressions are pinned here, both found in review of PB-5345.
 *
 ...
 *    is precisely the PB-4115 failure the ack protocol exists to prevent.
...
describe("telemetry props carry no raw identifiers", () => {
  ...
  it("drops workspace slug, tab id and window url if a context still carries them", () => {
    const leaky: FreezeBreadcrumb = {
      ...hang,
      context: {
        windowUrl: "file:///Users/someone/Applications/Patchbay.app/index.html",
        desktopRoute: {
          surface: "tab",
          path: "/:slug/issues",
          workspaceSlug: "acme",
  ...
  // PB-5345: stack capture is gone, but a machine upgrading from v0.4.13–
        ...
        stack: [
          {
            ...
            url: "file:///Users/someone/Applications/Patchbay.app/out/renderer/main.js",
