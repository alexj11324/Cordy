...
/**
 * Seeds the local-only workspace state used by the Vite browser preview.
 * This component is a no-op in Electron and is only rendered when the Vite
 * browser bridge explicitly enables it.
 */
