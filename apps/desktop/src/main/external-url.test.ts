...
describe("isSafeExternalHttpUrl", () => {
  it("allows http and https URLs", () => {
    expect(isSafeExternalHttpUrl("https://orvilo.aspectlylabs.com")).toBe(true);
...
describe("openExternalSafely", () => {
  ...
  it("forwards http/https URLs to shell.openExternal", () => {
    openExternalSafely("https://orvilo.aspectlylabs.com");
    expect(shell.openExternal).toHaveBeenCalledWith("https://orvilo.aspectlylabs.com");
  });
