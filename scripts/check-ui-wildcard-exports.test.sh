...
track "$importer"
cat >"$importer" <<'EOF'
export { UnusedExportProbe } from "@cordy/ui/components/ui/zz-unused-export-probe";
EOF
...
EOF
cat >"$mention" <<'EOF'
// import { CommentProbe } from "@cordy/ui/components/ui/zz-comment-probe";
const note = 'import { CommentProbe } from "@cordy/ui/components/ui/zz-comment-probe"';
