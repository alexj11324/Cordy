...
// server-rs/crates/patchbay-handler/assets/reserved_slugs.json (the single source
// of truth).
//
...
const jsonPath = resolve(
  repoRoot,
  "server-rs/crates/patchbay-handler/assets/reserved_slugs.json",
);
...
lines.push("// Do not edit by hand — edit the Rust handler asset:");
lines.push("// server-rs/crates/patchbay-handler/assets/reserved_slugs.json");
...
lines.push(" * `server-rs/crates/patchbay-handler/assets/reserved_slugs.json`.");
lines.push(" * The Rust backend embeds that JSON; this file is regenerated from it.");
lines.push(" *");
