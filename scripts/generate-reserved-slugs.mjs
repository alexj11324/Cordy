...
// server-rs/crates/cordy-handler/assets/reserved_slugs.json (the single source
// of truth).
//
...
const jsonPath = resolve(
  repoRoot,
  "server-rs/crates/cordy-handler/assets/reserved_slugs.json",
);
...
lines.push("// server-rs/crates/cordy-handler/assets/reserved_slugs.json");
