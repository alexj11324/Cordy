...
canonical_brew='alexj11324/Cordy/patchbay'
...
require_text CLI_INSTALL.md 'brew install alexj11324/Cordy/patchbay'
...
require_text scripts/install.sh 'BREW_PACKAGE="alexj11324/Cordy/patchbay"'
require_text scripts/install.sh 'brew tap alexj11324/Cordy'
...
require_text scripts/selfhost-wait.sh 'brew install alexj11324/Cordy/patchbay'
