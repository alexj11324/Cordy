-- Add a per-installation `region` so one Patchbay deployment can serve
...
-- deployment-wide value (the PATCHBAY_LARK_HTTP_BASE_URL /
-- PATCHBAY_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
