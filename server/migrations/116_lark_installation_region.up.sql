-- Add a per-installation `region` so one Cordy deployment can serve
...
-- deployment-wide value (the CORDY_LARK_HTTP_BASE_URL /
-- CORDY_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
