-- Restore Patchbay schema identity.

ALTER TABLE lark_user_binding RENAME COLUMN orvilo_user_id TO patchbay_user_id;
ALTER TABLE linear_sync_conflict RENAME COLUMN orvilo_issue_id TO patchbay_issue_id;
ALTER TABLE linear_issue_link RENAME COLUMN orvilo_issue_id TO patchbay_issue_id;
ALTER TABLE linear_project_binding RENAME COLUMN orvilo_project_id TO patchbay_project_id;
ALTER TABLE linear_member_binding RENAME COLUMN orvilo_user_id TO patchbay_user_id;
ALTER TABLE channel_user_binding RENAME COLUMN orvilo_user_id TO patchbay_user_id;
...
ALTER TABLE linear_comment_link ADD CONSTRAINT linear_comment_link_origin_check
    CHECK (origin IN ('linear', 'patchbay'));
