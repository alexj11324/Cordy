...
BEGIN
    ...
    IF invalid_count > 0 THEN
        RAISE EXCEPTION USING ERRCODE = '23514',
            CONSTRAINT = 'issue_active_executor_required',
            MESSAGE = format('%s active issues lack executors; assign valid executors or explicitly move them to a non-active status before retrying migration 601', invalid_count);
    END IF;
END
$$;
