-- Reverse 447_automation_rename.up.sql.
...
ALTER TABLE automation_run RENAME CONSTRAINT automation_run_team_id_fkey TO autopilot_run_squad_id_fkey;
...
ALTER TABLE autopilot_trigger RENAME COLUMN automation_id TO autopilot_id;
ALTER TABLE autopilot_run RENAME COLUMN automation_id TO autopilot_id;
ALTER TABLE autopilot_rule_version RENAME COLUMN automation_id TO autopilot_id;
ALTER TABLE autopilot_subscriber RENAME COLUMN automation_id TO autopilot_id;
ALTER TABLE autopilot_collaborator RENAME COLUMN automation_id TO autopilot_id;
