...
// `my-plugin/orvilo.plugin.json`. One leading directory is accepted; the
...
func TestParseBundleRejections(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			files: map[string]string{
				plugincontract.ManifestFilename: bundleManifest,
				"ui/main.js":                    "import { orvilo } from \"https://esm.sh/@orvilo/plugin-sdk@1\";\n",
				"skills/pr-review/SKILL.md":     "Read the diff.\n",
			},
...
func TestSurfaceEntryModuleDetection(t *testing.T) {
	refused := map[string]string{
		"bare import":                    "import { orvilo } from \"./sdk.js\";\n",
		"indented import":                "  import { orvilo } from \"./sdk.js\";\n",
		"import after a line comment":    "// set up\nimport { orvilo } from \"./sdk.js\";\n",
		"import after a block comment":   "/* set up */ import { orvilo } from \"./sdk.js\";\n",
