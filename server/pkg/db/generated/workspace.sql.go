...
VALUES ($1, $2, $3, $4, $5)
RETURNING id, name, slug, description, settings, created_at, updated_at, context, repos, issue_prefix, issue_counter, avatar_url, attribution_fail_closed, lead_agent_id
`
...
SELECT id, name, slug, description, settings, created_at, updated_at, context, repos, issue_prefix, issue_counter, avatar_url, attribution_fail_closed, lead_agent_id FROM workspace
WHERE id = $1
`
...
type UpdateWorkspaceParams struct {
	...
	LeadAgentIDSet bool        `json:"lead_agent_id_set"`
