...
not import any other Cordy package, so it can be reused by other services or
...
import (
    ...
    "github.com/cordy-ai/cordy/server/pkg/composio"
)
...
link, err := client.CreateLink(ctx, composio.CreateLinkRequest{
    ...
    UserID:       cordyUserID.String(), // your own user id
    CallbackURL:  "https://cordy.ai/api/integrations/composio/callback",
})
...
- **Standalone.** Zero coupling to Cordy internals — depend on this package
