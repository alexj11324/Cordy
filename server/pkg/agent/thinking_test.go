...
// contract: a future Codex effort should reach the picker without a Patchbay
...
// TestThinkingControlSupported pins which runtimes Patchbay can actually hand a
