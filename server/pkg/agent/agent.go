...
type ExecOptions struct {
	Cwd   string
	Model string
	// SystemPrompt carries the Cordy runtime brief for the few providers
	...
	// went stale as backends were added, which is how CORDY_QWENPAW_ARGS
...
// be based on a backend Cordy officially supports.
