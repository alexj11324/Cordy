...
type BuiltinRuntime struct {
	...
	// when ORVILO_<ID>_PATH is not set (e.g. "omp").
	DefaultCommand string

	// EnvPrefix is the ORVILO_ prefix for *_PATH and *_MODEL env overrides
	// (e.g. "ORVILO_OMP" → ORVILO_OMP_PATH / ORVILO_OMP_MODEL).
	EnvPrefix string
