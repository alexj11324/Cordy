...
type BuiltinRuntime struct {
	...
	// when PATCHBAY_<ID>_PATH is not set (e.g. "omp").
	DefaultCommand string

	// EnvPrefix is the PATCHBAY_ prefix for *_PATH and *_MODEL env overrides
	// (e.g. "PATCHBAY_OMP" → PATCHBAY_OMP_PATH / PATCHBAY_OMP_MODEL).
	EnvPrefix string
