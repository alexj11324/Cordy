...
// ([MUL-2946](https://cordy/issues/MUL-2946)). Subsequent PRs use
...
const (
	// Platform / scheduler side: failure attributable to Cordy
	...
	// message. Treated as platform-side because it is a Cordy-imposed
	...
	// CORDY_OPENCLAW_CLI_TIMEOUT or speed the CLI up, which is why the
