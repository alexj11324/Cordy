...
//
// The `http` transport already has this: CORDY_PLUGIN_DEV_ORIGINS names exact
...
const DevOriginsEnv = "CORDY_PLUGIN_DEV_ORIGINS"
...
const DevCAEnv = "CORDY_PLUGIN_DEV_CA"
