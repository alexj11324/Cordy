...
//
// The `http` transport already has this: ORVILO_PLUGIN_DEV_ORIGINS names exact
...
const DevOriginsEnv = "ORVILO_PLUGIN_DEV_ORIGINS"
...
const DevCAEnv = "ORVILO_PLUGIN_DEV_CA"
