...
func TestRunRuntimeProfileList(t *testing.T) {
	...
	t.Setenv("CORDY_WORKSPACE_ID", "ws-123")
...
func TestRunRuntimeProfileSetPathPreservesExistingConfig(t *testing.T) {
	...
	seed := cli.CLIConfig{ServerURL: "https://api.cordy.ai", WorkspaceID: "ws-123", Token: "mul_xyz"}
	...
	if cfg.ServerURL != "https://api.cordy.ai" || cfg.WorkspaceID != "ws-123" || cfg.Token != "mul_xyz" {
