...
var rootHelpTemplate = `Work seamlessly with Cordy from the command line.

USAGE
  cordy <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ cordy daemon start
  $ cordy agent list --output json

ENVIRONMENT VARIABLES
  CORDY_SERVER_URL    Override the default server URL
  CORDY_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`cordy <command> <subcommand> --help`" + ` for more information about a command.
`
