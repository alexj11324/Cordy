...
// handler package (same convention as the X-Cordy-Next-Before cursors in
...
Examples:
  ...
  cordy issue timeline MUL-123 --action status_changed

  # Every state change, no comment bodies
  cordy issue timeline MUL-123 --activity-only --output json

  # What changed since yesterday?
  cordy issue timeline MUL-123 --since 2026-08-19T00:00:00Z`,
	Args: exactArgs(1),
