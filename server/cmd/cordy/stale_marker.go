...
//
// Any CORDY_* task identity in the environment means the daemon really did
// launch this process, so the marker is doing its job. CORDY_DAEMON_PORT
...
func leftoverDaemonTaskMarkerPath() string {
	if inAgentExecutionContext() ||
		...
		strings.TrimSpace(os.Getenv("CORDY_DAEMON_PORT")) != "" {
		return ""
	}
