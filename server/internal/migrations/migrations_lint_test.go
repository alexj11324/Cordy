...
var legacyDuplicateMigrationStems = map[string][]string{
	...
	"043": {"043_audit_reserved_slugs", "043_fix_orphaned_automation_runs"},
	...
	"079": {"079_automation_run_skipped_status", "079_backfill_api_invalid_request", "079_github_integration"},
	"083": {"083_attachment_chat_columns", "083_runtime_visibility"},
	"084": {"084_team", "084_task_usage_dashboard_rollup"},
	"091": {"091_automation_webhook_triggers", "091_issue_start_date", "091_pr_ci_conflict"},
	"095": {"095_agent_thinking_level", "095_backfill_starter_content_state"},
	"096": {"096_automation_team_assignee", "096_pending_check_suite", "096_user_profile_description"},
	...
	"120": {"120_automation_subscriber", "120_comment_source_task_id", "120_github_pending_installation", "120_runtime_profile"},
	"122": {"122_lark_chat_session_binding_thread_reply", "122_task_handoff_note"},
	"124": {"124_automation_run_planned_at", "124_channel_generalization", "124_task_prepare_lease"},
	"127": {"127_issue_pull_request_reference_only", "127_task_team_id", "127_user_composio_connection"},
	"128": {"128_agent_task_queue_runtime_mcp_overlay", "128_automation_collaborator", "128_comment_routing_escalation"},
}
