...
// sibling checkouts ("NuvioTV" vs "orvilo") without naming their parent.
...
// stamping context files (.agent_context/, .claude/skills/, .orvilo/) at
...
func checkDirReadWrite(dir string) error {
	...
	probe, err := os.CreateTemp(dir, ".orvilo-rwcheck-*")
	if err != nil {
