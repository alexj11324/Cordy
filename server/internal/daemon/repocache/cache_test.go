...
// for the Orvilo Agent to every commit made in the worktree.
...
// path: a bare cache that already carries the Orvilo prepare-commit-msg hook
...
// without the Orvilo marker (e.g. one a user added manually) must be left
