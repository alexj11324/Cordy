...
type Task struct {
	...
	IsLeaderTask                  bool                   `json:"is_leader_task,omitempty"`      // true when executing in the team-leader coordinator role
	...
	ChatChannelDeliversFiles      bool                   `json:"chat_channel_delivers_files,omitempty"`
	...
	AgentThreadAttachments        []ChatAttachmentMeta   `json:"agent_thread_attachments,omitempty"`  // attachments linked to a task-level continuation turn
	...
	RegenerateQuickActionsFor     string                 `json:"regenerate_quick_actions_for,omitempty"`
	...
	HandoffNote                   string                 `json:"handoff_note,omitempty"`                // executor handoff instruction; rendered into the opening prompt + issue_context.md
