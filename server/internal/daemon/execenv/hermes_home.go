...
//   - populates the task-local `skills/` dir with ONLY the Orvilo-bound skills,
...
//     Orvilo product concern — the host's local Hermes memory must not bleed
...
// Orvilo-bound skills. They keep their natural slug (no user skills share this
