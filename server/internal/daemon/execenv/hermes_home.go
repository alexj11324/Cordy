...
//   - populates the task-local `skills/` dir with ONLY the Cordy-bound skills,
...
//     Cordy product concern — the host's local Hermes memory must not bleed
...
const hermesTaskLocalStateMarker = ".cordy-task-local-state-v1"
...
// Cordy-bound skills. They keep their natural slug (no user skills share this
