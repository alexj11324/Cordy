...
//   - populates the task-local `skills/` dir with ONLY the Patchbay-bound skills,
...
//     Patchbay product concern — the host's local Hermes memory must not bleed
...
// Patchbay-bound skills. They keep their natural slug (no user skills share this
