...
const (
	orviloMemoryFeatureBeginMarker = "# BEGIN orvilo-managed memory-feature (do not edit; regenerated by daemon)"
	orviloMemoryFeatureEndMarker   = "# END orvilo-managed memory-feature"
	orviloMemoryConfigBeginMarker  = "# BEGIN orvilo-managed memory-config (do not edit; regenerated by daemon)"
	orviloMemoryConfigEndMarker    = "# END orvilo-managed memory-config"
)
...
var memoryFeatureBlockRe = regexp.MustCompile(
	`(?ms)^` + regexp.QuoteMeta(orviloMemoryFeatureBeginMarker) +
		`.*?^` + regexp.QuoteMeta(orviloMemoryFeatureEndMarker) + `\n*`)

var memoryConfigBlockRe = regexp.MustCompile(
	`(?ms)^` + regexp.QuoteMeta(orviloMemoryConfigBeginMarker) +
		`.*?^` + regexp.QuoteMeta(orviloMemoryConfigEndMarker) + `\n*`)
...
func renderOrviloMemoryFeatureBlock(inFeaturesTable bool) string {
	...
	b.WriteString(orviloMemoryFeatureBeginMarker)
	b.WriteString("\n")
	if inFeaturesTable {
	...
	b.WriteString(orviloMemoryFeatureEndMarker)
	b.WriteString("\n")
	return b.String()
}
...
func renderOrviloMemoryConfigBlock(inMemoriesTable bool) string {
	var b strings.Builder
	b.WriteString(orviloMemoryConfigBeginMarker)
	b.WriteString("\n")
	if inMemoriesTable {
	...
	b.WriteString(orviloMemoryConfigEndMarker)
	b.WriteString("\n")
	return b.String()
}
