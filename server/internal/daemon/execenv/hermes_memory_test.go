...
func TestHermesMemoryStorePathLayout(t *testing.T) {
	...
	want := filepath.Join(home, ".orvilo", hermesMemoryStoreRoot, agent, "research")
	if got != want {
...
func TestPruneHermesMemoryStores(t *testing.T) {
	...
	root := filepath.Join(home, ".orvilo", hermesMemoryStoreRoot)
...
func TestPruneHermesMemoryStoresDisabled(t *testing.T) {
	...
	store := filepath.Join(home, ".orvilo", hermesMemoryStoreRoot, "agent-1", "default")
