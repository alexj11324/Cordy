...
func TestHermesMemoryStorePathLayout(t *testing.T) {
	...
	want := filepath.Join(home, ".cordy", hermesMemoryStoreRoot, agent, "research")
	if got != want {
...
func TestPruneHermesMemoryStores(t *testing.T) {
	...
	root := filepath.Join(home, ".cordy", hermesMemoryStoreRoot)
...
func TestPruneHermesMemoryStoresDisabled(t *testing.T) {
	...
	store := filepath.Join(home, ".cordy", hermesMemoryStoreRoot, "agent-1", "default")
