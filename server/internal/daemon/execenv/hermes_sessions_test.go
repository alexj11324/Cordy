...
func TestHermesSessionStorePathLayout(t *testing.T) {
	...
	want := filepath.Join(home, ".cordy", hermesSessionStoreRoot, agent, "research", issue)
	if got != want {
...
func TestPruneHermesSessionStores(t *testing.T) {
	...
	root := filepath.Join(home, ".cordy", hermesSessionStoreRoot)
...
func TestPruneHermesSessionStoresDisabled(t *testing.T) {
	...
	store := filepath.Join(home, ".cordy", hermesSessionStoreRoot, "agent-1", "default", "issue-1")
