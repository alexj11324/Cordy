...
// in the patchbay binary. The daemon runs Prepare/Reuse in that subprocess so a
...
const PreparationHelperArg = "__patchbay_execenv_prepare"
...
// name the current patchbay binary followed by PreparationHelperArg in
