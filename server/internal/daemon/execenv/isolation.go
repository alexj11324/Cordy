...
// in the cordy binary. The daemon runs Prepare/Reuse in that subprocess so a
...
const PreparationHelperArg = "__cordy_execenv_prepare"
...
// name the current cordy binary followed by PreparationHelperArg in
