...
This file records source evidence for `cordy-squads/SKILL.md`.
...
```bash
cordy squad list
cordy squad get <squad-id>
cordy squad create
cordy squad update <squad-id>
cordy squad delete <squad-id>
cordy squad activity <issue-id> <outcome>

cordy squad member list <squad-id>
cordy squad member add <squad-id>
cordy squad member remove <squad-id>
...
- agent member roster rows list assigned workspace skills via
  ...
  "no skills assigned"; builtin cordy-* skills are excluded and human
