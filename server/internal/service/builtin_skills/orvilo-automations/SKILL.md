...
- `create_issue` creates an Orvilo issue, making the run visible as issue state.
...
```bash
orvilo automation memory list <automation-id>
orvilo automation memory read <automation-id> MEMORIES.md
orvilo automation memory write <automation-id> MEMORIES.md --file <local-markdown-file> --revision <revision-from-read>
orvilo automation memory delete <automation-id> MEMORIES.md --revision <revision-from-read>
```
