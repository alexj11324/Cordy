...
For building mention links, load `orvilo-mentioning` instead — not this skill.
...
is to open or update a PR before posting the final Orvilo issue comment, unless
...
When a step depends on PR state, query Orvilo's link table — do not infer it
