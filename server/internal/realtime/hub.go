...
// loadTrustedProxies reads the same ORVILO_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("ORVILO_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared ORVILO_TRUSTED_PROXIES value in here at startup.
