...
const (
	...
	TaskConfigRootEnv = "PATCHBAY_TASK_CONFIG_ROOT"
)
...
type CLIConfig struct {
	...
	// PATCHBAY_DAEMON_DEVICE_NAME env, this field, os.Hostname().
	...
	// PATCHBAY_AGENT_RUNTIME_NAME env, this field, the built-in
	// DefaultRuntimeName.
	...
	// --workspaces-root flag, PATCHBAY_WORKSPACES_ROOT env, this field, the
	...
	// PATCHBAY_DAEMON_MAX_CONCURRENT_TASKS env, this field, default.
	...
	// PATCHBAY_DAEMON_POLL_INTERVAL env, this field, DefaultPollInterval.
	...
	// flag, PATCHBAY_DAEMON_HEARTBEAT_INTERVAL env, this field,
	...
	// explicit 0), PATCHBAY_AGENT_TIMEOUT env, this field,
	// DefaultAgentTimeout.
	...
	// PATCHBAY_CODEX_SEMANTIC_INACTIVITY_TIMEOUT env, this field,
	...
	// PATCHBAY_CODEX_HANDSHAKE_TIMEOUT env, this field,
	...
	// --no-auto-update flag, PATCHBAY_DAEMON_AUTO_UPDATE=false env, this
	...
	// --auto-update-interval flag, PATCHBAY_DAEMON_AUTO_UPDATE_INTERVAL
	...
	// --no-auto-reload flag, PATCHBAY_DAEMON_AUTO_RELOAD=false env, this
...
//
//	BinaryPath: PATCHBAY_OPENCLAW_PATH (env)  > backends.openclaw.binary_path > PATH lookup
//	StateDir:   OPENCLAW_STATE_DIR (env)     > backends.openclaw.state_dir   > OpenClaw's built-in default (~/.openclaw)
//	CLITimeout: PATCHBAY_OPENCLAW_CLI_TIMEOUT (env) > backends.openclaw.cli_timeout > built-in default
//
// The StateDir env var here is OpenClaw's own OPENCLAW_STATE_DIR — NOT a new
// PATCHBAY_OPENCLAW_STATE_DIR. Rationale: OpenClaw already honors its own env
...
// OpenClaw's own env, PATCHBAY_OPENCLAW_STATE_DIR can be layered on top
...
type OpenClawOverride struct {
	...
	//
	// Resolution mirrors the fields above: PATCHBAY_OPENCLAW_CLI_TIMEOUT (env) >
