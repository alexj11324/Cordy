...
type CLIConfig struct {
	...
	// ORVILO_DAEMON_DEVICE_NAME env, this field, os.Hostname().
	...
	// ORVILO_AGENT_RUNTIME_NAME env, this field, the built-in
	// DefaultRuntimeName.
	...
	// --workspaces-root flag, ORVILO_WORKSPACES_ROOT env, this field, the
	...
	// ORVILO_DAEMON_MAX_CONCURRENT_TASKS env, this field, default.
	...
	// ORVILO_DAEMON_POLL_INTERVAL env, this field, DefaultPollInterval.
	...
	// flag, ORVILO_DAEMON_HEARTBEAT_INTERVAL env, this field,
	...
	// explicit 0), ORVILO_AGENT_TIMEOUT env, this field,
	// DefaultAgentTimeout.
	...
	// ORVILO_CODEX_SEMANTIC_INACTIVITY_TIMEOUT env, this field,
	...
	// ORVILO_CODEX_HANDSHAKE_TIMEOUT env, this field,
	...
	// --auto-update-interval flag, ORVILO_DAEMON_AUTO_UPDATE_INTERVAL
	...
	// --no-auto-reload flag, ORVILO_DAEMON_AUTO_RELOAD=false env, this
...
//
//	BinaryPath: ORVILO_OPENCLAW_PATH (env)  > backends.openclaw.binary_path > PATH lookup
//	StateDir:   OPENCLAW_STATE_DIR (env)     > backends.openclaw.state_dir   > OpenClaw's built-in default (~/.openclaw)
//	CLITimeout: ORVILO_OPENCLAW_CLI_TIMEOUT (env) > backends.openclaw.cli_timeout > built-in default
//
// The StateDir env var here is OpenClaw's own OPENCLAW_STATE_DIR — NOT a new
// ORVILO_OPENCLAW_STATE_DIR. Rationale: OpenClaw already honors its own env
...
// OpenClaw's own env, ORVILO_OPENCLAW_STATE_DIR can be layered on top
...
type OpenClawOverride struct {
	...
	//
	// Resolution mirrors the fields above: ORVILO_OPENCLAW_CLI_TIMEOUT (env) >
