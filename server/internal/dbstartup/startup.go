...
const (
	StartupTimeoutEnv = "ORVILO_DATABASE_STARTUP_TIMEOUT"
	ConnectTimeoutEnv = "ORVILO_DATABASE_CONNECT_TIMEOUT"
	...
	startupStartedAtEnv = "ORVILO_INTERNAL_DATABASE_STARTUP_STARTED_AT_UNIX"
