...
// (Cordy Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Cordy Cloud Fleet service rather than by hitting our
...
// CORDY_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.cordy.cloud). Trailing slashes are trimmed.
