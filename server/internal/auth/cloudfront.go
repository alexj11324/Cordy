...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.aspectlylabs.com"
	cookieDomain string // cookie scope, e.g. ".aspectlylabs.com"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.aspectlylabs.com")
//   - COOKIE_DOMAIN           (e.g. ".aspectlylabs.com")
