...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.patchbay.ai"
	cookieDomain string // cookie scope, e.g. ".patchbay.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.patchbay.ai")
//   - COOKIE_DOMAIN           (e.g. ".patchbay.ai")
