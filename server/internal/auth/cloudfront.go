...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.cordy.ai"
	cookieDomain string // cookie scope, e.g. ".cordy.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.cordy.ai")
//   - COOKIE_DOMAIN           (e.g. ".cordy.ai")
