...
func TestChannelLeaseMetricsRegisterAndRecord(t *testing.T) {
	...
	want := map[string]bool{
		"orvilo_channel_lease_operations_total":                          false,
		"orvilo_channel_lease_active_owners":                             false,
		"orvilo_channel_lease_owners_with_renewal_errors":                false,
		"orvilo_channel_lease_last_successful_renewal_timestamp_seconds": false,
		"orvilo_channel_lease_takeover_latency_seconds":                  false,
	}
