...
func TestChannelLeaseMetricsRegisterAndRecord(t *testing.T) {
	...
	want := map[string]bool{
		"cordy_channel_lease_operations_total":                          false,
		"cordy_channel_lease_active_owners":                             false,
		"cordy_channel_lease_owners_with_renewal_errors":                false,
		"cordy_channel_lease_last_successful_renewal_timestamp_seconds": false,
		"cordy_channel_lease_takeover_latency_seconds":                  false,
	}
