...
func TestNormalizePR3LabelsCollapseUnknownValues(t *testing.T) {
	...
	tests := []struct {
		...
		{"automation_cadence_unknown", metrics.NormalizeAutomationCadence, "every_5_min", "unknown", "unknown"},
		{"automation_trigger_unknown", metrics.NormalizeAutomationTrigger, "future_kind", "unknown", "unknown"},
		{"automation_skip_reason_unknown", metrics.NormalizeAutomationSkipReason, "lunar_phase", "other", "other"},
