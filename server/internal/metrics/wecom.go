...
func NewWecomMetrics() *WecomMetrics {
	counter := func(name, help string) prometheus.Counter {
		return prometheus.NewCounter(prometheus.CounterOpts{
			Namespace: "orvilo", Subsystem: "wecom", Name: name, Help: help,
		})
	}
	return &WecomMetrics{
		...
		OutboundDropped: prometheus.NewCounterVec(prometheus.CounterOpts{
			Namespace: "orvilo", Subsystem: "wecom", Name: "outbound_dropped_total",
		...
		OutboundSkipped: prometheus.NewCounterVec(prometheus.CounterOpts{
			Namespace: "orvilo", Subsystem: "wecom", Name: "outbound_skipped_total",
		...
		AttachmentDropped: prometheus.NewCounterVec(prometheus.CounterOpts{
			Namespace: "orvilo", Subsystem: "wecom", Name: "outbound_attachment_dropped_total",
		...
		OutboundUnconfirmed: prometheus.NewCounterVec(prometheus.CounterOpts{
			Namespace: "orvilo", Subsystem: "wecom", Name: "outbound_unconfirmed_total",
		...
		AttachmentUnconfirmed: prometheus.NewCounterVec(prometheus.CounterOpts{
			Namespace: "orvilo", Subsystem: "wecom", Name: "outbound_attachment_unconfirmed_total",
		...
		RelayShed: prometheus.NewCounterVec(prometheus.CounterOpts{
			Namespace: "orvilo", Subsystem: "wecom", Name: "outbound_relay_shed_total",
