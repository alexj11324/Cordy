...
// app-level token (xapp-) into Orvilo (the paste path lives in byo_install.go).
...
var (
	...
	// already connected to a live owner in a DIFFERENT Orvilo workspace — it
	...
	ErrTeamOwnedByAnotherWorkspace = errors.New("slack: this Slack app is already connected to a different Orvilo workspace")
...
// the pasted Slack app is already connected to a DIFFERENT agent or Orvilo
