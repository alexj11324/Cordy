...
// app-level token (xapp-) into Cordy (the paste path lives in byo_install.go).
...
var (
	...
	// already connected to a live owner in a DIFFERENT Cordy workspace — it
	...
	ErrTeamOwnedByAnotherWorkspace = errors.New("slack: this Slack app is already connected to a different Cordy workspace")
...
// the pasted Slack app is already connected to a DIFFERENT agent or Cordy
