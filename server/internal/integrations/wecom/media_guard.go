...
// IsLinkLocal* / IsCordyst / IsUnspecified), minus the handful of
...
// CORDY_WECOM_MEDIA_ALLOW_CIDRS=::/0 — or, just as well, =2002::/16 —
...
// boot from CORDY_WECOM_MEDIA_ALLOW_CIDRS. An unparseable entry is reported
