...
// WeCom can be continued from the Orvilo web UI, and that answer's artifacts
// belong in Orvilo — pushing them into a group chat puts a file in front of
...
func TestProcessEvent_AWebUIAnswerDeliversNeitherWordsNorFile(t *testing.T) {
	...
	q.channelIngested = askedInTheWebUI() // asked in Orvilo, not over WeCom
