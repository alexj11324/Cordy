...
// WeCom can be continued from the Patchbay web UI, and that answer's artifacts
// belong in Patchbay — pushing them into a group chat puts a file in front of
...
func TestProcessEvent_AWebUIAnswerDeliversNeitherWordsNorFile(t *testing.T) {
	...
	q.channelIngested = askedInTheWebUI() // asked in Patchbay, not over WeCom
