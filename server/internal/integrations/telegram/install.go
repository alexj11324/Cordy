...
// its token into Orvilo. The InstallService owns the at-rest encryption of
...
var (
	...
	// ErrCredentialsUnverifiable means Orvilo could not complete the live
	...
	// live owner in a DIFFERENT Orvilo workspace.
	ErrBotOwnedByAnotherWorkspace = errors.New("telegram: this bot is already connected to a different Orvilo workspace")
...
// chat sessions stay in Orvilo. The Supervisor stops supervising the
