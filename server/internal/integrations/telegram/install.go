...
// its token into Patchbay. The InstallService owns the at-rest encryption of
...
var (
	...
	// ErrCredentialsUnverifiable means Patchbay could not complete the live
	...
	// live owner in a DIFFERENT Patchbay workspace.
	ErrBotOwnedByAnotherWorkspace = errors.New("telegram: this bot is already connected to a different Patchbay workspace")
...
// chat sessions stay in Patchbay. The Supervisor stops supervising the
