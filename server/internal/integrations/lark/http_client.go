...
const (
	...
	// latency from a self-hosted Patchbay deployment to feishu.cn.
...
// keyed by app_id so a single Patchbay server reuses Lark's
...
func bindingPromptTemplate(bindURL string) (string, error) {
	doc := map[string]any{
		...
		"header": map[string]any{
			"template": "blue",
			"title":    map[string]any{"tag": "plain_text", "content": "Patchbay"},
		},
		"elements": []any{
			map[string]any{
				"tag": "div",
