...
//     and an expiry. Orvilo renders the QR, the user scans it in the
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Orvilo's `source`
...
// cannot attribute installs back to Orvilo in their analytics.
//
