...
//     and an expiry. Patchbay renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Patchbay. Empty defaults
	// to "patchbay".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Patchbay's `source`
...
// cannot attribute installs back to Patchbay in their analytics.
//
