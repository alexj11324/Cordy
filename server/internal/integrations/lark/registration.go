...
//     and an expiry. Cordy renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Cordy. Empty defaults
	// to "cordy".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Cordy's `source`
...
// cannot attribute installs back to Cordy in their analytics.
//
