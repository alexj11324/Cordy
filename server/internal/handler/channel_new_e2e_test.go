...
import (
	...
	slackintegration "github.com/orvilo-ai/orvilo/server/internal/integrations/slack"
...
// old generation must keep both its Orvilo Chat and exact external reply
...
func TestChannelChatCommandE2ERotatesRouteAndFreezesTaskDelivery(t *testing.T) {
	...
	// The empty channel-created Chat remains writable from Orvilo. Its first
