...
// other: the team briefing (server-side, appended to the leader's
...
// leaderCommentRuntimeBrief renders the CLAUDE.md a team leader receives on a
...
// scope fix (MUL-3724 path): the issue belongs to a plain agent and this team
