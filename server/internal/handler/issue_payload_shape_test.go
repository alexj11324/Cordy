...
func fullyPopulatedIssue(t *testing.T) db.Issue {
	...
	return db.Issue{
		...
		OwnerID:        parseUUID("88888888-8888-8888-8888-888888888888"),
		ExecutorType:   pgtype.Text{String: "agent", Valid: true},
		ExecutorID:     parseUUID("33333333-3333-3333-3333-333333333333"),
		ReviewerType:   pgtype.Text{String: "member", Valid: true},
		ReviewerID:     parseUUID("99999999-9999-9999-9999-999999999999"),
		CreatorType:    "member",
