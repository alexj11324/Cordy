...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"agent_coordination_assignment":            workspaceDelete,
	"agent_coordination_outbox":                workspaceDelete,
	...
	"agent_task_execution_provenance":          workspaceDelete,
	...
	"automation_run":                           workspaceDelete,
	"automation_subscriber":                    workspaceDelete,
	"automation_trigger":                       workspaceDelete,
	...
	"channel_installation_runtime_observation": workspaceDelete,
	...
	"channel_receive_state":                    workspaceDelete,
	...
	"dependency_graph_edge":                    workspaceDelete,
	"dependency_graph_issue_created_outbox":    workspaceDelete,
	"dependency_graph_node":                    workspaceDelete,
	"dependency_graph_plan":                    workspaceDelete,
	"desktop_auth_handoff":                     workspaceDeleteKeep,
	...
	"guest_session":                            workspaceDeleteKeep,
	...
	"linear_project_binding":                   workspaceDelete,
	"linear_sync_conflict":                     workspaceDelete,
	"linear_sync_inbox":                        workspaceDelete,
	"linear_sync_outbox":                       workspaceDelete,
	...
	"slack_oauth_state":                        workspaceDelete,
	"team":                                     workspaceDelete,
	"team_member":                              workspaceDelete,
	"sys_cron_executions":                      workspaceDeleteKeep,
	"task_message":                             workspaceDelete,
	"task_token":                               workspaceDelete,
	"authorization_grant":                      workspaceDelete,
	"authorization_audit_event":                workspaceDelete,
	...
	"terminal_report_receipt":                  workspaceDelete,
	...
	"work_product":                             workspaceDelete,
	"work_product_relation":                    workspaceDelete,
	"workspace":                                workspaceDelete,
	"workspace_channel":                        workspaceDelete,
	"workspace_channel_message":                workspaceDelete,
	"workspace_issue_category_policy":          workspaceDelete,
