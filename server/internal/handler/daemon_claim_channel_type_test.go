...
// mis-flag made the daemon inject `orvilo attachment upload` guidance into a
...
// `orvilo chat history` and `orvilo chat thread`, and both endpoints are
...
// inherited the web chat's `orvilo attachment upload` guidance, the exact
