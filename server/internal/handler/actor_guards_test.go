...
// request that passed Auth as a JWT or ovy_ PAT does NOT carry
...
func TestRequireHumanActor_AllowsHumanRequest(t *testing.T) {
	...
	// No X-Actor-Source — this is the JWT / ovy_ PAT shape.
...
//     ovy_ PAT) leaves the header empty. So "non-empty AND not
