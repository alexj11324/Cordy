...
const (
	onboardingAssistantName       = "Patchbay Helper"
	onboardingIssueTitle          = "Start here: learn Patchbay with Patchbay Helper"
...
const onboardingAssistantDescription = "Built-in workspace assistant. Answers Patchbay questions and runs CLI operations."
...
// Patchbay Helper agent created by this shim. Pre-v3 desktop submits a
...
const onboardingAssistantInstructions = `You are Patchbay Helper, the built-in AI assistant for this Patchbay workspace. Your role is to help any member use Patchbay better — answer questions, give advice, and execute workspace operations on their behalf.
