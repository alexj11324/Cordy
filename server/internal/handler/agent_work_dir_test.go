...
func TestRelativeWorkDir(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			workDir:  "/Users/alice/orvilo_workspaces/" + wsID + "/" + taskSeg + "/workdir",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/alice/orvilo_workspaces/" + wsID + "/" + taskSeg,
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/alice/orvilo_workspaces/asset-feed-" + wsSeg + "/mul-6063-" + taskSeg + "/workdir",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/alice/orvilo_workspaces/asset-feed-a05b0e10/mul-6063-5c57b65b/workdir",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/alice/orvilo_workspaces/" + wsID + "/5c57b65b/workdir",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/df007df/code/work/projects/orvilo/foo",
			wsID:     wsID,
			taskID:   taskID,
			expected: "code/work/projects/orvilo/foo",
		},
		{
		...
		},
		{
			...
			workDir:  `C:\Users\alice\orvilo_workspaces\` + wsID + `\` + taskSeg + `\workdir`,
			wsID:     wsID,
			taskID:   taskID,
			expected: wsID + "/" + taskSeg + "/workdir",
		},
		{
			...
			wsID:     "",
			taskID:   taskID,
			expected: "orvilo_workspaces/" + wsID + "/" + taskSeg + "/workdir",
		},
		{
...
func TestTaskToResponseDerivesPrivateDurableWorkDir(t *testing.T) {
	response := taskToResponse(db.AgentTaskQueue{
		DurableWorkDir: pgtype.Text{
			String: "/Users/alice/repos/orvilo",
			Valid:  true,
		},
	}, "")

	if response.DurableWorkDir != "/Users/alice/repos/orvilo" {
		t.Fatalf("durable_work_dir = %q, want absolute clipboard value", response.DurableWorkDir)
	}
	if response.RelativeDurableWorkDir != "repos/orvilo" {
