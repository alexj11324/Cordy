...
Recovered from PR #750 (commit `0b5de131a1a2c1080045eb628932c74d574af708`).
The migration is numbered 601 because 585 is already used on main.

Migration 601 rejects direct INSERT or UPDATE when an issue in `in_progress`,
