...
- [x] PR #261 `codex/cord-93-cli-runtime-schema` is the next bounded child of
      ...
      `git diff --check` remains clean.
- [x] PR #262 `codex/cord-94-cli-project-resource-support` is the next
      ...
      subagent review PASS on `ae8bbde45c6ac80b29d7966a0b8da62f89b0e59b`:
      support builders/resolver/extraction helpers preserve payload, generic
      JSON, github/local-directory shortcut, UUID-prefix, borrow/async, and
      ...
      clean.
- [x] PR #263 `codex/cord-95-cli-agent-lifecycle` is the next bounded child
      ...
      CLEAN/MERGEABLE. Exact-head subagent review PASS on
      `af34a524e7988b88a25883aae535043765d73e91`: lifecycle/tasks/avatar
      imports and visibility are complete; avatar extension/5 MiB/path/
...
- [x] PR #264 `codex/cord-96-cli-agent-skills` is the next bounded child of
      ...
      `f4f24889f15110e6d00235001e3866ca29cd75cc`, candidate
      `0fe026260e374eca60541a5af7694d66b5d89869` (parents base + head).
      It isolates agent skill list/set/add and table formatting in
      `agent_skill_commands.rs`; skill ID validation, empty-set behavior, API
...
- [x] PR #266 `codex/cord-98-cli-agent-mcp` is the completed bounded child of
      ...
      (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review PASS;
      no Cargo was run and no production behavior changed.
- [x] PR #267 `codex/cord-99-cli-agent-copy` is the completed bounded child of
      #266: base branch `codex/cord-98-cli-agent-mcp` at
      `036da9b2bad7aaed29714617b25ecc84b53a8759`, exact head
      `c30121f6fd05f9ebe0726a850f911410b7fc9ba7`, tree
      `cbc7e00f21a54f1a394ca416b525f44c81cda454`, candidate
      `30ce65a8a92539578e087baa86e1e58c56684624` (parents base + head).
      It isolates agent copy orchestration in `agent_copy_commands.rs`;
      source lookup, runtime/model rules, permissions, skills, secret input,
      API payload, output, dispatch, and re-exports remain unchanged. Scoped
      pinned rustfmt and `git diff --check` pass; Cargo is delegated. PR #267
      is Ready (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review
      PASS; no Cargo was run and no production behavior changed.
- [x] PR #273 `codex/cord-105-cli-skill-files` is the completed bounded child of
...
- [x] PR #268 `codex/cord-100-cli-agent-read` is the completed bounded child of
      ...
      Exact-head subagent review PASS; no Cargo was run and no production
      behavior changed.
- [x] PR #271 `codex/cord-103-cli-skill-mutation` is the completed bounded child of
      #270: base branch `codex/cord-102-cli-skill-read` at
      `7a06e7ffc68fc78fded05baf0aad6c33a01b9e04`, exact head
      `a01278fac06cf86e26a0d9498ede5ca0f021e92a`, tree
      `36e653873df70962ad7203b68b4ed8ebcc434c90`, candidate
      `f3acdc8291b906dc000562aa9b1feea51a70e8f9` (parents base + head).
      It isolates skill content input, create/update/delete handlers in
      `skill_mutation_commands.rs`; file/stdin safety, validation, payloads,
      confirmation, API paths, output, and root re-exports remain unchanged.
...
- [x] PR #301 `codex/cord-133-cli-issue-property-values` is the completed bounded
      ...
      `c407bdf28f61d463c7fd97d78efd3f7aeea87183`, candidate
      `0b9618082c989ab9e5c7caa5132eb55f36195e1a` (parents base + head).
      It isolates issue-property actor resolution, typed value encoding, actor
      lookup inputs, and display conversion in `issue_property_values.rs`;
...
- [x] PR #302 `codex/cord-134-cli-issue-task-output` is the completed bounded child
      of #301: base branch `codex/cord-133-cli-issue-property-values` at
      `61e7b4379f7b0f51e4dba37308767dfd851e9964`, current exact head
      `529d464a3e7926cd1325733d0b10348a93334416`, tree
      `29848f751a04c695f94b858bb4a8e96e939ed61a`, candidate
      `ce65ab197552acd494378a4d78b512ab8b45b5bc` (parents base + head).
      It isolates task-run and run-message table formatting in
      `issue_task_output.rs`; task-run resolution, API paths, JSON output,
      cancellation, truncation, and command dispatch remain unchanged.
      The first review found a real formatter re-export compile blocker; the
      delegated minimal fix `529d464a` makes `lib.rs` import the moved
      formatters from `issue_task_output`. Scoped pinned rustfmt and
...
- [x] PR #303 `codex/cord-135-cli-issue-timeline-filter` is the completed bounded
      ...
      subagent review PASS on `593e1db0`; no Cargo was run.
- [x] PR #304 `codex/cord-136-cli-issue-timeline-output` is the completed bounded
      child of #303: base branch `codex/cord-135-cli-issue-timeline-filter` at
      `593e1db0a6ef39280e5eb3b8e18c1207e943f133`, exact head
      `3b2b289f99b639463a1bc3ebc224176944468474`, tree
      `66cedaecd9696eefa15de30bdcbe51467b16c53c`, candidate
      `efac007137bb7cbe6e24eb7fb13ea1f2562ce8a8` (parents base + head).
      It isolates timeline actor/detail/transition/table rendering in
      `issue_timeline_output.rs`; filter semantics, actor lookup inputs, API
      requests, truncation warnings, and command dispatch remain unchanged.
      Scoped pinned rustfmt and `git diff --check` pass; Cargo is delegated.
...
- [x] PR #305 `codex/cord-137-cli-api-url-normalization` is the completed bounded
      ...
      `32d251bd0adb651553f0fa21fcec83c15c8d38d2`, candidate
      `5fa277ce511a19935e2dcfb6f1fbeedc2d8da83b` (parents base + head).
      It isolates `normalize_api_base_url` in `client_url.rs`; ws/wss
...
- [x] PR #307 `codex/cord-139-cli-project-reference` is the completed bounded child of
      ...
      `c7c87c64265f4d1b97ac93bd1b239b9ef8495035`, candidate
      `b627d704d4da196113fedbd455e8ddda74bd2bfe` (parents base + head).
      It isolates canonical UUID/project-prefix and URL-encoded project reference
      resolution in `project_reference_resolver.rs`; actor/member/agent/squad
...
- [x] PR #308 `codex/cord-140-cli-config-persistence` is the completed bounded child of
      #307: base branch `codex/cord-139-cli-project-reference` at
      `e1ac3bd5aa11f449ea1afe17ed1c1c9acabbccd7`, exact head
      `4ef44cf098a148d2fe05eab0010bd18839750b77`, tree
      `a4115b5accec4df87059bb4fc2926a9d8eed7506`, candidate
      `5b19f6f400d33203bf8844ffe1c251080800a2cd` (parents base + head).
      It isolates locked profile document reads, restricted directory/file
      permissions, atomic replacement, temporary-file cleanup, and directory
      sync in `config_persistence.rs`; `Environment` APIs, JSON shape, lock
      behavior, task-root validation, and setup/login semantics remain unchanged.
      Scoped pinned rustfmt and `git diff --check` pass; Cargo is delegated.
      PR #308 is Ready (`isDraft=false`), MERGEABLE (checks pending). Exact-head
      subagent review PASS on `4ef44cf0`; no Cargo was run.
- [x] PR #309 `codex/cord-141-cli-autopilot-resolvers` is the completed bounded child of
      ...
      (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review PASS on
      `ee0f82dd`; no Cargo was run.
- [x] PR #310 `codex/cord-142-cli-issue-markdown-safety` is the completed bounded child
      of #309: base branch `codex/cord-141-cli-autopilot-resolvers` at
      `ee0f82ddb0f7f01b55a8a2d60f5f76dfab67f4f8`, exact head
      `5563b95faa406b81335960778e45e50e1470a8c1`, tree
      `0d99168f9e43de622bcf2834cb14700dc059121f`, candidate
      `e4378a83cd4c6ff12ada1fa6499bcf1b8a0b3642` (parents base + head).
      It isolates Markdown destination parsing and runtime-local target
      classification in `issue_markdown_links.rs`; issue safety context checks,
      remediation text, code-span/fence exclusions, file URL detection, path
      normalization, deduplication, and errors remain unchanged. Scoped pinned
...
- [x] PR #311 `codex/cord-143-cli-issue-description` is the completed bounded child of
      ...
      `fdd07e327951794877935b1bb6e20dff0a2ca668`, candidate
      `b079420eaa516ea46670a42900bdf318121124ff` (parents base + head).
      It separates create/update description source resolution while preserving
      inline/stdin/file exclusivity, workdir checks, newline trimming,
...
- [x] PR #312 `codex/cord-144-cli-project-output` is the completed bounded child of
      ...
      `4f75667a5def8218f7905389f63188e5bd06c8f7`, candidate
      `b7ec24e0f126229b612b491a033aae535228d5c7` (parents base + head).
      It isolates project lead/actor enrichment and table rendering from project
...
- [x] PR #313 `codex/cord-145-cli-config-profile-resolution` is the completed bounded
      ...
      was run.
- [x] PR #314 `codex/cord-146-cli-daemon-lifecycle-output` is the completed bounded
...
- [x] PR #315 `codex/cord-147-cli-daemon-launch-inputs` is the completed bounded child
      ...
      `21aac09327f575e424eb94efc8c23c53fe722534`, candidate
      `b11df01c38095162563c8adfcec47bfdf270eba5` (parents base + head).
      It isolates daemon launch flag conversion and validation; flag mapping,
      restart foreground guard, health-port contract, duration parsing, and
...
- [x] PR #316 `codex/cord-148-cli-daemon-status-output` is the completed bounded child
      ...
      was run.
- [x] PR #317 `codex/cord-149-cli-daemon-profile-discovery` is the completed bounded
      ...
      unchanged. Scoped pinned rustfmt and `git diff --check` pass; Cargo is
      delegated. PR #317 is Ready (`isDraft=false`), MERGEABLE (checks pending).
      Exact-head subagent review PASS on `541f9b80`; no Cargo was run.
- [x] PR #318 `codex/cord-150-cli-daemon-log-io` is the completed bounded child of
      #317: base branch `codex/cord-149-cli-daemon-profile-discovery` at
      `541f9b8091da7b623a26c318261d2860eed71e2f`, exact head
      `51a7ef849afc828950ace7fa2854f69a102d141b`, tree
      `3a6132bd08bc2d52058d98335490a7f0c1d7b054`, candidate
      `ad01c92ca56cc82fa6b450ff286716a5f5ee4886` (parents base + head).
      It isolates bounded daemon log tail/follow I/O; line/byte limits,
      truncation handling, Ctrl-C cancellation, and command notices remain
...
- [x] PR #319 `codex/cord-151-cli-daemon-disk-usage-command` is the completed bounded
...
- [x] PR #320 `codex/cord-152-cli-api-request-builder` is the completed bounded child
...
- [x] PR #321 `codex/cord-153-cli-api-attachment-download` is the completed bounded child
      ...
      `da02ebbcefa3e39bfda2254598839d8af416b120`, candidate
      `11c43df6f8cc21980a084b323d2c9f1ba526bd1b` (parents base + head).
      It isolates attachment download URL selection and bounded response
...
- [x] PR #322 `codex/cord-154-cli-issue-reorder-output` is the completed bounded child
      ...
      `git diff --check` pass; Cargo and exact-head subagent review are
      delegated. PR #322 is Ready (`isDraft=false`), CLEAN/MERGEABLE (checks
      pending). Exact-head subagent review PASS on `0737c6a1`; no Cargo was run.
- [x] PR #323 `codex/cord-155-cli-issue-reorder-query` is the completed bounded child
      of #322: base branch `codex/cord-154-cli-issue-reorder-output` at
      `0737c6a104ca1bf2baf775f745ce530bdd41315b`, exact head
      `5566463818f9df67588901a12aea495e115f4cac`, tree
      `c55bef4531bc41fb9548f2a29e32761da46d759b`, candidate
      `2c5d48e027a97216182ec28cf3508c053a1bda92` (parents base + head).
      It isolates issue-column pagination and cross-column diagnostics;
      query ordering, page limits, offset handling, and error wording remain
      unchanged. Scoped pinned rustfmt and `git diff --check` pass; Cargo and
      exact-head subagent review PASS on `55664638`; no Cargo was run. PR #323
      is Ready (`isDraft=false`), MERGEABLE (checks pending).
- [x] PR #324 `codex/cord-156-cli-issue-metadata-output` is the completed bounded child
      of #323: base branch `codex/cord-155-cli-issue-reorder-query` at
      `5566463818f9df67588901a12aea495e115f4cac`, exact head
      `d8b75e1c97e0966147c8686b0fc62fc9f0a4b9bb`, tree
      `2344eef64db37a9abc05d3f373dd9bbb19f37bc9`, candidate
      `3b8956ed22f81bae3a82f4d413c4e4ff8b582a55` (parents base + head).
      It isolates metadata extraction/type labels and JSON/table rendering;
      sorted keys, value formatting, and mutation/parser behavior remain
      unchanged. Scoped pinned rustfmt and `git diff --check` pass; Cargo and
      exact-head subagent review PASS on `d8b75e1c`; no Cargo was run. PR #324
      is Ready (`isDraft=false`), MERGEABLE (checks pending).
- [x] PR #325 `codex/cord-157-cli-issue-metadata-read` is the completed bounded child
      of #324: base branch `codex/cord-156-cli-issue-metadata-output` at
      `d8b75e1c97e0966147c8686b0fc62fc9f0a4b9bb`, exact head
      `1154fa6431329e7612c5a62b38740ef23a61b5e2`, tree
      `23f7c390001541b56dd320ce9ef65cd1065b2ac1`, candidate
      `f6093ed2a8b9ff856978afa7bb0d7fccf8f2f0b2` (parents base + head).
      It isolates metadata list/get reads; 404-as-empty behavior, key lookup,
      JSON/table output, and mutation/parser paths remain unchanged. Scoped
      pinned rustfmt and `git diff --check` pass; Cargo and exact-head
      subagent review PASS on `1154fa64`; no Cargo was run. PR #325 is Ready
      (`isDraft=false`), MERGEABLE (checks pending).
- [x] PR #326 `codex/cord-158-cli-issue-metadata-mutations` is the completed bounded
      child of #325: base branch `codex/cord-157-cli-issue-metadata-read` at
      `1154fa6431329e7612c5a62b38740ef23a61b5e2`, exact head
      `040dce279c3b4206e3e6134b93cf5a84bcaa803c`, tree
      `e92a3de2e15ef2d8697234da24b95cf3e9765afe`, candidate
      `72d9f882b74e53ddd603603e096da3cfc7ac3676` (parents base + head).
      It isolates metadata set/delete workflows; endpoints, rendering,
      delete fallback, and value parser behavior remain unchanged. Scoped
      pinned rustfmt and `git diff --check` pass; Cargo and exact-head
...
- [x] PR #329 `codex/cord-161-cli-property-read` is the completed bounded child of
...
- [x] PR #330 `codex/cord-162-cli-property-mutation-input` is the completed bounded
...
- [x] PR #331 `codex/cord-163-cli-property-mutation-output` is the completed bounded
      ...
      `1bd7f044cf7cfde6c433b7f4a5bee3130a219036`, candidate
      `75d7f795b80af4131a3f347a2de406e7df1ce32d` (parents base + head).
      It isolates property create/update/archive output rendering while
...
- [x] PR #332 `codex/cord-164-cli-issue-property-output` is the completed bounded
      ...
      `181958569b700318cbc65a902dc9b798a7afa104`, candidate
      `cd335c8691a0bd10182385dff92af06a192fb476` (parents base + head).
      It extracts IssuePropertyRow construction and JSON/table rendering while
...
- [x] PR #333 `codex/cord-165-cli-issue-property-actor` is the completed bounded
...
- [x] PR #334 `codex/cord-166-cli-issue-property-value-encoding` is the completed
      ...
      review PASS on `9d71ab4c`; no Cargo was run.
- [x] PR #299 `codex/cord-131-cli-api-health` is the completed bounded child of
      ...
      is Ready (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review
      PASS: health probe/tests, URL validation, redirect/timeout/status/error
      handling, re-exports, setup calls, and module wiring are unchanged; no
      Cargo was run.
- [x] PR #298 `codex/cord-130-cli-api-skill-import` is the completed bounded child of
      ...
      CLEAN/MERGEABLE. Exact-head subagent review PASS: skill import filename
      fallback, multipart fields, endpoint, auth/request handling, response
      decoding, and module/test wiring are unchanged; no Cargo was run.
- [x] PR #297 `codex/cord-129-cli-api-attachments` is the completed bounded child of
      ...
      `fa31aa0c59001a9b60b2686192ff3402fd5b53a8`, candidate
      `278a5ca46cbf1dd806810a8c0a30d02871edc02d` (parents base + head).
      It isolates ApiClient attachment upload/download transport and response
      DTOs in `api_attachments.rs`; generic JSON client construction, request
...
- [x] PR #296 `codex/cord-128-cli-config-mutation` is the completed bounded child of
      ...
      `64ee95283dfc67b44e58baf1123c72dba91b69e0`, candidate
      `1e6b95ede299aa79a46b7b1fa7dd0cffc2cb790c` (parents base + head).
      It names config set/validation/Go duration+bool parsing as
...
- [x] PR #295 `codex/cord-127-cli-config-read` is the completed bounded child of
      ...
      `766df45ccd2fa01aae7ac031d1c31651702c7641`, tree
      `67d337736910171e2da82f034fa4c466ce7df332`, candidate
      `86aebe89f63bf8c3ce1a148a2a4fef27c17dc744` (parents base + head).
      It isolates config show/document normalization/table+JSON rendering in
      `config_read_commands.rs`; config set validation, Go parsing, and profile
      writes remain unchanged. Scoped pinned rustfmt and `git diff --check`
      pass; Cargo is delegated. PR #295 is Ready (`isDraft=false`),
      CLEAN/MERGEABLE. Exact-head subagent review PASS: config show/document
      normalization, rendering, config set validation/writes, Go parsing,
      visibility, dispatch, and tests are unchanged; no Cargo was run.
- [x] PR #294 `codex/cord-126-cli-runtime-update-output` is the completed bounded child of
      #293: base branch `codex/cord-125-cli-runtime-profile-path` at
      `a1e1c9b561c77748c9af39e6e2ddab814db9229b`, exact head
      `a460d024c6138951b2088c8b0189014680a67282`, tree
      `fc1ab56ae77235cfa4b430dca99dc11c22ca6b5f`, candidate
      `8f2dc0c9b70d67313d6b694cb225c9c6db5a0395` (parents base + head).
      It isolates runtime update table/JSON rendering in
      `runtime_update_output.rs`; update request, polling, timeout, status, and
      error policy remain unchanged. Scoped pinned rustfmt and
      `git diff --check` pass; Cargo is delegated. PR #294 is Ready
      (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review PASS:
      update request/polling/timeout/status/error semantics, JSON/table output,
      tests, and module wiring are unchanged; no Cargo was run.
- [x] PR #293 `codex/cord-125-cli-runtime-profile-path` is the completed bounded child of
      #292: base branch `codex/cord-124-cli-runtime-profile-mutation` at
      `7718af948bf18f75b62844f6088c9722a9039fe2`, exact head
      `a1e1c9b561c77748c9af39e6e2ddab814db9229b`, tree
      `84f6c3e426f1c53407b007e7eccf14cffb3c3e41`, candidate
      `a1ff63d2d0bd47c9ceac06b43b209d48caadf5a2` (parents base + head).
      It isolates local runtime profile set-path/unset-path policy in
      `runtime_profile_path_commands.rs`; human-local guards, absolute-path
      validation, config mutation, output, and dispatch remain unchanged.
      Scoped pinned rustfmt and `git diff --check` pass; Cargo is delegated.
      PR #293 is Ready (`isDraft=false`), CLEAN/MERGEABLE. Exact-head
      subagent review PASS: pure rename; local guard, path validation, config
      writes, output, and dispatch wiring are unchanged; no Cargo was run.
- [x] PR #292 `codex/cord-124-cli-runtime-profile-mutation` is the completed bounded child of
      #291: base branch `codex/cord-123-cli-runtime-profile-read` at
      `f4b90df30f7690e889f822b28a793b0b017d3fbf`, exact head
      `7718af948bf18f75b62844f6088c9722a9039fe2`, tree
      `0866bc6e1bc9ea4b3d1393983a247d3362301858`, candidate
      `196f969a24a5086ab4f267421709629d0ae3a9e1` (parents base + head).
      It isolates runtime profile create/update/delete and protocol validation
      in `runtime_profile_mutation_commands.rs`; request payloads, workspace
      paths, conflict handling, output, and local path policy remain intact.
      Scoped pinned rustfmt and `git diff --check` pass; Cargo is delegated.
      PR #292 is Ready (`isDraft=false`), CLEAN/MERGEABLE. Exact-head
      subagent review PASS: create/update/delete validation, payloads, paths,
      conflict handling, output, and local path wiring are unchanged; no Cargo
      was run.
- [x] PR #291 `codex/cord-123-cli-runtime-profile-read` is the completed bounded child of
      ...
      `192ba770880bc3c0c6d1bb1164531f7730ce52d9`, candidate
      `a990030911fd14c97a915aa3047a679a1f1d2ac2` (parents base + head).
      It isolates runtime profile listing/response/path helpers in
...
- [x] PR #290 `codex/cord-122-cli-runtime-mutation` is the completed bounded child of
      ...
      `2a97456da553b71d40ea2f61e5fb24806fc0dd15`, tree
      `143dd82e7a5cd16ac249b811ada9b8bec0a63863`, candidate
      `77eb27f0ff343431e5b73f439bafed3aa2b08a81` (parents base + head).
      It isolates runtime rename/delete handlers in
      `runtime_mutation_commands.rs`; payloads, conflict/cascade handling,
      output, dispatch, and errors remain unchanged. Scoped pinned rustfmt and
      `git diff --check` pass; Cargo is delegated. PR #290 is Ready
      (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review PASS:
      rename/delete payloads, conflict/cascade handling, output, errors, and
      module wiring are unchanged; no Cargo was run.
- [x] PR #289 `codex/cord-121-cli-runtime-read` is the completed bounded child of
      ...
      `e26610e69923a3fbcdd0b117787c4712009b8f54`, candidate
      `8d0a0231687dcde9c9dad3bf4c0b4129f264b069` (parents base + head).
      It isolates runtime list/usage/activity handlers in
...
- [x] PR #287 `codex/cord-119-cli-attachment-upload` is the completed bounded child of
      ...
      `c95bd717f687e0d015127714330dc0dc016e9257`, candidate
      `bc43d3de4cc460e75ebb2299b8d9d9397d895675` (parents base + head).
      It isolates attachment upload and markdown rendering in
      `attachment_upload_commands.rs`; task context, local-path validation,
...
- [x] PR #286 `codex/cord-118-cli-chat-read` is the completed bounded child of
      ...
      `339968f3e6bf75365d2b0c7ea22f275c396be61b`, candidate
      `557cc4bf998a60f2339a5738106adcf5f7dd76bf` (parents base + head).
      It isolates chat read/query encoding and output formatting in
...
- [x] PR #284 `codex/cord-116-cli-repo-mutation` is the completed bounded child of
      ...
      `38b46665bf0b9d246e7db7caa562bf3998b93348`, tree
      `ec8a55a4fffb2aeb4598381dbef7c55adf2109be`, candidate
      `01b11ac510201516585b041b3e991a7b61df4ba8` (parents base + head).
      It isolates repository URL validation and add/remove mutations in
      `repo_mutation_commands.rs`; workspace fetch/patch, validation,
      deduplication, payloads, output, dispatch, and tests remain unchanged.
      Scoped pinned rustfmt and `git diff --check` pass; Cargo is delegated.
      PR #284 is Ready (`isDraft=false`), CLEAN/MERGEABLE. Exact-head
      subagent review PASS; no Cargo was run and no production behavior
      changed.
- [x] PR #283 `codex/cord-115-cli-repo-read` is the completed bounded child of
...
- [x] PR #282 `codex/cord-114-cli-autopilot-webhook` is the completed bounded child of
      ...
      `c6ac25e50eb1ddf390e667185bd353ad225a70bc`, tree
      `0fee6adfd409a1a30e3abc28a0b9c412955b1496`, candidate
      `2ef23b03cce89919bdd4082d49e99ccc629e212b` (parents base + head).
      It isolates webhook URL rotation and confirmation in
      `autopilot_trigger_webhook_commands.rs` and removes the empty legacy
      module; confirmation, resolver, API, output, dispatch, and tests remain
      unchanged. Scoped pinned rustfmt and `git diff --check` pass; Cargo is
      delegated. PR #282 is Ready (`isDraft=false`), CLEAN/MERGEABLE.
      Exact-head subagent review PASS; no Cargo was run and no production
      behavior changed.
- [x] PR #281 `codex/cord-113-cli-autopilot-trigger-mutation` is the completed bounded child of
      #280: base branch `codex/cord-112-cli-autopilot-trigger` at
      `1aa47b0b1d5b446f38115945c9c5ba841d7c8670`, exact head
      `881069628d76a2c8238b91324678cb8edc6b0e56`, tree
      `01674d02c2993f372bb55128952df9c7c6570499`, candidate
      `ad6f9e6fb1a89176e3cd1ccf21558370a7db83a9` (parents base + head).
      It isolates autopilot trigger add/update/delete in
      `autopilot_trigger_mutation_commands.rs`; validation, resolver behavior,
      API payloads, output, dispatch, and tests remain unchanged. Scoped pinned
      rustfmt and `git diff --check` pass; Cargo is delegated. PR #281 is Ready
      (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review is
      PASS; no Cargo was run and no production behavior changed.
- [x] PR #280 `codex/cord-112-cli-autopilot-trigger` is the completed bounded child of
...
- [x] PR #279 `codex/cord-111-cli-autopilot-mutation` is the completed bounded child of
      ...
      `6c21e52ea23a1e6192cdc9a92a60717190181d19`, tree
      `37e475b777e174c8a5b85f36e7c1902b60a1cd91`, candidate
      `00cf5105058cf69ab7e71314be2823023f0e5909` (parents base + head).
      It isolates autopilot create/update/delete handlers in
      `autopilot_mutation_commands.rs`; validation, resolver behavior, API
      payloads, output, dispatch, and tests remain unchanged. Scoped pinned
      rustfmt and `git diff --check` pass; Cargo is delegated. PR #279 is Ready
      (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review is
      PASS; no Cargo was run and no production behavior changed.
- [x] PR #278 `codex/cord-110-cli-autopilot-read` is the completed bounded child of
      #277: base branch `codex/cord-109-cli-squad-activity` at
      `5809faeb924c66e8eb3403e70aacbda285680073`, exact head
      `18214804c5f1d28b5c0cc88f2525a3e5b2b3edad`, tree
      `666fd5142135a3f0e88dc430a0f4cc0f2cf85749`, candidate
      `9fe830e8bac14fd44e62ce1ae9007ee44e2949be` (parents base + head).
      It isolates autopilot list/get/runs handlers in
      `autopilot_read_commands.rs`; resolver behavior, query encoding,
      table/JSON output, dispatch, and tests remain unchanged. Scoped pinned
      rustfmt and `git diff --check` pass; Cargo is delegated. PR #278 is Ready
      (`isDraft=false`), MERGEABLE (checks pending). Exact-head subagent review
      PASS; no Cargo was run and no production behavior changed.
- [x] PR #277 `codex/cord-109-cli-squad-activity` is the completed bounded child of
      #276: base branch `codex/cord-108-cli-squad-member` at
      `5287fa671f9b269efac95d5f2baae4d80daeda64`, exact head
      `5809faeb924c66e8eb3403e70aacbda285680073`, tree
      `0ed27dd7b3bc28bc13e0482bd10e910d481e773a`, candidate
      `1d38cb7b81848a84670e5516d905314df8098a8d` (parents base + head).
      It isolates squad activity/evaluation in `squad_activity_commands.rs`;
      outcome validation, issue resolution, API payloads, output, dispatch, and
      behavior remain unchanged. Scoped pinned rustfmt and `git diff --check`
      pass; Cargo is delegated. PR #277 is Ready (`isDraft=false`),
      CLEAN/MERGEABLE. Exact-head subagent review PASS; no Cargo was run and no
      production behavior changed.
- [x] PR #276 `codex/cord-108-cli-squad-member` is the completed bounded child of
      ...
      `6a0de1cbd1fff9624b3b0f48b52dc2ca96d82ea4`, candidate
      `740d586862d72a197f9bcb97ad83bb7a45f9f24d` (parents base + head).
      It isolates squad member list/add/set-role/remove and output formatting
      in `squad_member_commands.rs`; type/role validation, encoded IDs,
...
- [x] PR #275 `codex/cord-107-cli-squad-mutation` is the completed bounded child of
      ...
      `c24a4b026a9f37901d757114cddcf3711106f061`, tree
      `924f3a4fd8bbbd41510f54fd5f7b6f0e36512075`, candidate
      `aeaa61d0e097f12258363b3993d85f7264603168` (parents base + head).
      It isolates squad create/update/delete and leader resolution in
      `squad_mutation_commands.rs`; validation, encoded IDs, payloads, API
      calls, output, dispatch, and tests remain unchanged. Scoped pinned
      rustfmt and `git diff --check` pass; Cargo is delegated. PR #275 is Ready
      (`isDraft=false`), MERGEABLE (checks pending). Exact-head subagent review
      PASS; no Cargo was run and no production behavior changed.
- [x] PR #274 `codex/cord-106-cli-squad-read` is the completed bounded child of
...
- [x] PR #272 `codex/cord-104-cli-skill-catalog` is the completed bounded child of
      ...
      `1c9553018c328be9b3b239d676ff1202694e4229`, tree
      `a73aae4f7cfa375feda6997d9e3eb5b9033be8ad`, candidate
      `611b3deeac5b75a7eda6dd124393d74b0e045c6d` (parents base + head).
      It isolates skill import/refresh/search, archive parsing, result/error
      formatting, upload bounds, and timeout policy in
      `skill_catalog_commands.rs`; skill file commands remain separate. Scoped
      pinned rustfmt and `git diff --check` pass; Cargo is delegated. PR #272
      is Ready (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review
      PASS; no Cargo was run and no production behavior changed.
- [x] PR #270 `codex/cord-102-cli-skill-read` is the completed bounded child of
      ...
      (`isDraft=false`), CLEAN/MERGEABLE. Exact-head subagent review PASS; no
      Cargo was run and no production behavior changed.
