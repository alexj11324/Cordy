 ...
 * the SDK ships to plugin authors and must not pull `@orvilo/core` or
 * `@orvilo/ui` in behind it, and the host must not depend on a package a
...
/**
 * Installed by Orvilo's bootstrap before any plugin code executes. The guest
