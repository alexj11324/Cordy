...
const AGENT_STORAGE_KEY = "orvilo:chat:selectedAgentId";
const PROJECT_STORAGE_KEY = "orvilo:chat:selectedProjectId";
const SESSION_STORAGE_KEY = "orvilo:chat:activeSessionId";
...
const DRAFT_ATTACHMENTS_KEY = "orvilo:chat:draft-attachments";
/**
 ...
 */
const APPLIED_RESTORES_KEY = "orvilo:chat:applied-draft-restores";
/**
...
const CHAT_EXPANDED_KEY = "orvilo:chat:expanded";
/**
 ...
 */
const OPEN_KEY = "orvilo:chat:isOpen";
/**
 ...
 */
const FLOATING_KEY = "orvilo:chat:floatingChatEnabled";
