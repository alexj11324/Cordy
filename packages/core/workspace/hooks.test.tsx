...
describe("useActorName", () => {
  ...
  // MUL-4985 regression: while the member/agent/team directory queries are
  ...
  it("resolves names once the directories are loaded", () => {
    ...
    const teams = [{ id: "team-1", name: "Core", avatar_url: null }];
    setApiInstance({
    ...
    qc.setQueryData(workspaceKeys.teams("ws-1"), teams);
