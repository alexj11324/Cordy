...
describe("useDeleteWorkspace", () => {
  ...
  it("clears the deleted slug's workspace-scoped storage on success", async () => {
    ...
    defaultStorage.setItem("orvilo_issue_draft:delete-me", "draft");
    defaultStorage.setItem("orvilo_issue_draft:keep-me", "draft");
    ...
    expect(defaultStorage.getItem("orvilo_issue_draft:delete-me")).toBeNull();
    expect(defaultStorage.getItem("orvilo_issue_draft:keep-me")).toBe("draft");
  });
