...
// Do not edit by hand — edit the Rust handler asset:
 ...
 * `server-rs/crates/cordy-handler/assets/reserved_slugs.json`.
 * The Rust backend embeds that JSON; this file is regenerated from it.
 *
...
export const RESERVED_SLUGS: ReadonlySet<string> = new Set([
  ...
  // `cordy` is reserved as the brand name to block impersonation workspaces.
