...
import type { AutopilotTrigger } from "@cordy/core/types";
import { renderWithI18n } from "../../test/i18n";

// Regression cover for PB-5649: editing a manual-only autopilot (no triggers)
...
vi.mock("@cordy/core/hooks", () => ({ useWorkspaceId: () => "ws-test" }));
vi.mock("@cordy/core/paths", () => ({ useCurrentWorkspace: () => ({ name: "Acme" }) }));
...
vi.mock("@cordy/core/projects/queries", () => ({
...
vi.mock("@cordy/core/autopilots/queries", () => ({
...
vi.mock("@cordy/core/autopilots/mutations", () => ({
