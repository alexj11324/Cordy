...
import type { WebhookEventFilter } from "@cordy/core/types";
...
export function WebhookEventFilterSection({
  ...
  const docsHref = i18n.language?.startsWith("zh")
    ? `https://cordy.ai/docs/zh/autopilots#${encodeURIComponent("事件过滤")}`
    : "https://cordy.ai/docs/autopilots#event-filters";
