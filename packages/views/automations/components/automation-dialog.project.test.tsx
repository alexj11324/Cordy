...
import type { AutomationExecutionMode } from "@patchbay/core/types";
import { renderWithI18n } from "../../test/i18n";

// Regression cover for MUL-6681 (GH #7550): the dialog rendered the Project
// section only for create_issue automations and sent `project_id: null` for
// run_only ones. A run_only automation could therefore never be bound to a
...
describe("AutomationDialog project section", () => {
  ...
  it("offers the project picker to a run_only automation", async () => {
  ...
  it("keeps a run_only automation's project on save instead of clearing it", async () => {
  ...
  it("keeps a create_issue automation's project on save", async () => {
    const user = userEvent.setup();
