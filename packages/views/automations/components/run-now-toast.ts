// Classifies a manual "run now" outcome into a toast (PB-4525). Pure so it can
...
// The i18n key (under the automations `detail` namespace) describing why a
