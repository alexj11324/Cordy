 ...
 * gate would still be open. Creating the automation in that state persists it
 * and then fails to create its trigger, leaving an automation that can never
 ...
 * persists an automation whose trigger then 400s and never runs.
 *
