...
type AutomationsT = ReturnType<typeof useT<"automations">>["t"];
...
function formatDayList(t: AutomationsT, days: number[]): string {
...
export function describeSchedule(t: AutomationsT, config: ScheduleConfig): string | null {
