...
const SORT_FIELDS: AutomationSortField[] = [
  "name",
  "lastRun",
  "nextRun",
  "created",
...
export function AutomationListToolbar({
  ...
  scopeCounts: Record<AutomationScope, number>;
  filters: AutomationListFilters;
  onToggleFilter: (key: keyof AutomationListFilters, value: string) => void;
  onClearFilters: () => void;
  sortField: AutomationSortField;
  sortDirection: AutomationSortDirection;
  onSortFieldChange: (field: AutomationSortField) => void;
  onSortDirectionChange: (direction: AutomationSortDirection) => void;
  hiddenColumns: AutomationColumnKey[];
  onToggleColumn: (key: AutomationColumnKey) => void;
  ...
  const SORT_LABELS: Record<AutomationSortField, string> = {
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" className="w-auto">
            <DropdownMenuRadioGroup
              value={scope}
              onValueChange={(value) =>
                onScopeChange(value as AutomationScope)
              }
            >
              {AUTOMATION_SCOPES.map((s) => (
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="start" className="w-auto">
                    <DropdownMenuRadioGroup
                      value={sortField}
                      onValueChange={(v) =>
                        onSortFieldChange(v as AutomationSortField)
                      }
                    >
