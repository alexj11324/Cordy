...
const URL = "https://api.example.com/api/webhooks/automations/awt_supersecret";
...
describe("WebhookUrlField", () => {
  it("hides the token by default — the plaintext is not in the DOM", () => {
    ...
    expect(screen.getByText(/api\/webhooks\/automations\/•+/)).toBeInTheDocument();
  });
  ...
  it("re-hides when the URL changes — a rotated token is never inherited revealed", () => {
    const rotated = "https://api.example.com/api/webhooks/automations/awt_rotatedsecret";
