...
import type { RuntimeModelThinkingLevel } from "@cordy/core/types";
...
/**
 * Per-agent reasoning/effort picker (PB-2339). Renders only when the
 ...
 * the user's local CLI install, not by Cordy's catalog.
 */
      ...
      {levels.map((l) => (
        ...
        >
          ...
          {/* No model-factory-default badge here on purpose: when the
              picker is "Follow CLI config" (value === ""), Cordy omits
