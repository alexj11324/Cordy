...
describe("CreateIssueModal", () => {
  beforeEach(() => {
    ...
    mockClearDraft.mockImplementation(() => {
      ...
      next.manual.ownerId = mockDraftStore.lastOwnerId;
    ...
    mockApiUploadFile.mockResolvedValue({
      ...
      markdown_url: "https://orvilo-api.copilothub.ai/api/attachments/11111111-2222-3333-4444-555555555555/download",
  ...
  it("prunes draft attachments the reopened description no longer references", async () => {
    ...
    const deleted = {
      ...
      markdown_url: "https://orvilo-api.copilothub.ai/api/attachments/99999999-8888-7777-6666-555555555555/download",
    };
