...
const longRepoUrl =
  "https://github.com/orvilo-ai/a-very-long-repository-name-that-needs-a-tooltip";
const apiRepoUrl = "https://github.com/orvilo-ai/api";
const webRepoUrl = "https://github.com/orvilo-ai/web";
