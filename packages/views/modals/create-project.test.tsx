...
const longRepoUrl =
  "https://github.com/cordy-ai/a-very-long-repository-name-that-needs-a-tooltip";
const apiRepoUrl = "https://github.com/cordy-ai/api";
const webRepoUrl = "https://github.com/cordy-ai/web";
