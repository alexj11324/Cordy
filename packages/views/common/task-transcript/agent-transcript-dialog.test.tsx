...
import type { AgentRuntime, AgentTask } from "@orvilo/core/types/agent";
import { useTranscriptViewStore } from "@orvilo/core/agents/stores";
  ...
  it("states the agent once in the header, not on every prose row", () => {
    renderWithI18n(
      <AgentTranscriptDialog
        ...
        agentName="【Chores|Opus5】Orvilo Helper"
      />,
    );

    expect(screen.getAllByTestId("rich-content")).toHaveLength(3);
    expect(screen.getAllByText("【Chores|Opus5】Orvilo Helper")).toHaveLength(1);
