...
// agent thread event. Given one timeline event it decides visual kind, label, and
...
/**
 * A screenshot tool answers with a base64 image block, which the agent thread event
