// Syntax highlighting for agent thread event diffs. Highlighting runs over a whole
...
// content code block, so a Rust file looks the same in a agent thread event as it does
// in a comment.
...
// Agent thread event diff highlighting.
