...
vi.mock("@orvilo/core/issue-statuses/queries", async (importOriginal) => ({
  ...(await importOriginal<typeof import("@orvilo/core/issue-statuses/queries")>()),
  issueStatusListOptions: () => ({ queryKey: ["issue-statuses", "ws-1"] }),
}));
vi.mock("@orvilo/core/issue-statuses/mutations", () => ({
