...
vi.mock("@orvilo/ui/components/ui/hover-card", () => ({
...
vi.mock("@orvilo/ui/components/ui/button", async () => {
  const actual =
    await vi.importActual<typeof import("@orvilo/ui/components/ui/button")>(
      "@orvilo/ui/components/ui/button",
    );
  return {
    ...actual,
