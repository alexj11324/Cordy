...
import { useCommentComposerStore, useCommentDraftStore } from "@orvilo/core/issues/stores";
...
vi.mock("@orvilo/core/hooks/use-file-upload", async () => ({
  ...(await vi.importActual<typeof import("@orvilo/core/hooks/use-file-upload")>(
    "@orvilo/core/hooks/use-file-upload",
  )),
