...
export const PICKER_TRIGGER_CLASS =
  "inline-flex min-w-0 max-w-full items-center gap-1.5 whitespace-nowrap cursor-pointer rounded-md px-1 -mx-1 hover:bg-accent/30 transition-colors overflow-hidden";
