...
} from "@orvilo/core/issues/config";
...
import { formatActorRef, isActorPropertyType, isFilterablePropertyType, isScalarPropertyType, propertyFilterValueKey, PROPERTY_FILTER_OP_SYMBOLS, PROPERTY_FILTER_OPS_BY_TYPE, type PropertyFilterOp, type PropertyFilterValue } from "@orvilo/core/types";
...
import { actorFilterKey, baselineFromQuery, type IssueViewBaseline } from "@orvilo/core/issue-views/baseline";
import type { IssueView } from "@orvilo/core/api/schemas";
import { addDaysDateOnly, dateOnlyToLocalDate, formatDateOnly, toDateOnly, todayDateOnly } from "@orvilo/core/issues/date";
import {
  useIssuesScope,
  useIssuesScopeStore,
  type IssuesScope,
  type IssuesScopePageKey,
} from "@orvilo/core/issues/stores/issues-scope-store";
import { actorKindForViewVariant } from "@orvilo/core/issues/surface/scope";
...
export function IssueDisplayControls({
  ...
  const GROUPING_LABEL_KEY: Record<typeof GROUPING_OPTIONS[number]["value"], "group_status" | "group_executor" | "group_project"> = {
    status: "group_status",
