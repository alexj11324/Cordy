...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-6 -mb-6 flex flex-col-reverse gap-3 rounded-b-2xl border-t border-border p-6 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
...
function DialogTitle({ className, ...props }: DialogPrimitive.Title.Props) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-title-sm leading-none font-semibold",
        className
      )}
      {...props}
    />
