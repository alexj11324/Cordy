-- Canonical executor terminology for Automation and Quick Action targets.
-- This is a breaking schema cutover; application code no longer reads or
-- writes the legacy assignee column names.
BEGIN;
