...
--
--     PRD (rolling cordy-api, maxUnavailable:0) overlapped old and new pods.
...
CREATE INDEX idx_channel_user_binding_user
    ON channel_user_binding(cordy_user_id, workspace_id);
...
INSERT INTO channel_user_binding (
    id, workspace_id, cordy_user_id, installation_id,
