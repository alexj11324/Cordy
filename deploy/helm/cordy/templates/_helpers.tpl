...
under the kustomize layout when installed as `helm install cordy ...`.
*/}}
{{- define "cordy.backend.fullname" -}}
{{ .Release.Name }}-backend
{{- end -}}

{{- define "cordy.frontend.fullname" -}}
{{ .Release.Name }}-frontend
{{- end -}}

{{- define "cordy.postgres.fullname" -}}
...
*/}}
{{- define "cordy.databaseUrl" -}}
postgres://$(POSTGRES_USER):$(POSTGRES_PASSWORD)@{{ include "cordy.postgres.fullname" . }}:5432/$(POSTGRES_DB)?sslmode=disable
{{- end -}}
